...
pid_nums1=`ps aux | grep "/bin/bash.*onePerHour_php7_v2.sh" | grep -v grep | wc -l`
if [ $pid_nums1 -gt "2" ]
then
	echo " I exit"
	exit
...
#ebay 获取最近200条 buyer的评价
checkprocess ../../yii queue/cron-request-ebay-feedback
checkprocess ../../yii rumall/active-all-shop-to-get-unshipped-order

#cd跟卖终结者，检测open api调用情况
checkprocess ../../yii cdiscount/check-call-open-api-state
