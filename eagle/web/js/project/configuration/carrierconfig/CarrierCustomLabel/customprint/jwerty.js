 ...
 * @copyright Copyright 漏 2011, Keith Cirkel
 *
 */
(function (global, exports) {
    ...
    var _keys = {
        ...
        mods: {
            ...
            '鈱�': 17,
            ctrl: 17,
            // ALT key, on Mac: 鈱� (Alt)
            '鈱�': 18,
            alt: 18,
            option: 18,
            // META, on Mac: 鈱� (CMD), on Windows (Win), on Linux (Super)
            '鈱�': 91,
            meta: 91,
            cmd: 91,
            'super': 91,
        ...
        // Normal keys
        keys: {
            // Backspace key, on Mac: 鈱� (Backspace)
            '鈱�': 8,
            backspace: 8,
            // Tab Key, on Mac: 鈬� (Tab), on Windows 鈬モ嚗
            '鈬�': 9,
            '鈬�': 9,
            tab: 9,
            // Return key, 鈫�
            ...
            caps: 20,
            'caps-lock': 20,
            // Escape key, on Mac: 鈳�, on Windows: Esc
            '鈳�': 27,
            escape: 27,
            esc: 27,
            // Space key
            space: 32,
            // Page-Up key, or pgup, on Mac: 鈫�
            '鈫�': 33,
            pgup: 33,
            'page-up': 33,
            // Page-Down key, or pgdown, on Mac: 鈫�
            '鈫�': 34,
            pgdown: 34,
            'page-down': 34,
            // END key, on Mac: 鈬�
