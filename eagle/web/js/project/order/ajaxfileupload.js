...
jQuery.extend({
    ...
    createUploadForm: function(id, fileElementName, data)
	{
		...
		/////*****************************add input type hidden for data will be uploaded************************************************//////////////////
		if(data)
		{
			for(var i in data)
			{
		...
		///////*******************add input type file for files will be uploaded***********************************///////
		var files = document.getElementsByName(fileElementName);
