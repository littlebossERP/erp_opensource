...
<style>
    *{ margin:0; padding:0;}
    ...
    .ebay-step dl dt{ margin-top:12px;}
    ...
    <div class="ebay-step">
        <dl class="ebay-step-dl1">
            <dt><i><?php echo TranslateHelper::t('到');?></i>
                <em>
                    <a style="color: #52a3e4;text-decoration: none;" href="<?php echo Url::to(['/platform/ebay-accounts/listingbindseller1']);?>" target="_blank_ebay">
        ...
        <dl class="ebay-step-dl2">
            <dt><i><?php echo TranslateHelper::t('验证成功');?></i><em>
                    <a style="color: #52a3e4;text-decoration: none;border: 1px solid #52a3e4;padding: 2px 10px;border-radius: 3px;" href="#"  onclick="platform.ebayAccountsList.listingbindseller2('<?=@$accountname?>');">
