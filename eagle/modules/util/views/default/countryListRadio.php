		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane active" id="common_country">
				<div id='common_country_selected'>
					...
					<div class="country_label_div" id="country_common_<?=$common_countryVal ?>_div" onmouseover="show_add_span(this)" onmouseout="hidden_add_span(this)">
						<label <?php if(($common_countryVal == 'GB') || ($common_countryVal == 'UK')) echo 'class="label_red"'; ?>>
						<input type="radio" value="<?=$common_countryVal ?>" name="common_country[]" onclick="common_country_click(this)" en_name='<?=strtoupper($countryList[$common_countryVal]['en_name']) ?>-radio'>
						<?=$countryList[$common_countryVal]['cn'] ?></label>
			...
			<div role="tabpanel" class="tab-pane" id="asia_country">
				...
				<div class='country_label_div' id='country_label_div_<?=$tmpCountryKey ?>' onmouseover="show_add_span(this)" onmouseout="hidden_add_span(this)">
					<label>
					<input type="radio" value="<?=$tmpCountryKey ?>" name="country[]" onclick="country_click(this)" en_name='<?=strtoupper($countryList[$tmpCountryKey]['en_name']) ?>-radio'>
					<?=$tmpCountryVal['cn'] ?></label>
			...
			<div role="tabpanel" class="tab-pane" id="europe_country">
				...
				?>
				<div class='country_label_div' id='country_label_div_<?=$tmpCountryKey ?>' onmouseover="show_add_span(this)" onmouseout="hidden_add_span(this)">
					<label <?php if(($tmpCountryKey == 'GB') || ($tmpCountryKey == 'UK')) echo 'class="label_red"'; ?>>
					<input type="radio" value="<?=$tmpCountryKey ?>" name="country[]" onclick="country_click(this)" en_name='<?=strtoupper($countryList[$tmpCountryKey]['en_name']) ?>-radio'>
					<?=$tmpCountryVal['cn'] ?></label>
			...
			<div role="tabpanel" class="tab-pane" id="oceania_country">
				...
				<div class='country_label_div' id='country_label_div_<?=$tmpCountryKey ?>' onmouseover="show_add_span(this)" onmouseout="hidden_add_span(this)">
					<label>
					<input type="radio" value="<?=$tmpCountryKey ?>" name="country[]" onclick="country_click(this)">
					<?=$tmpCountryVal['cn'] ?></label>
