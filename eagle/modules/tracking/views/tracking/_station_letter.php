	...
	<div class="panel-body">
		<form class="form-horizontal" role="form" id="send-station-letter">
			...
			<div class="form-group">
				...
				<label for="track_no_list" class="col-sm-1 control-label"  qtipkey="message_receiver_track_no"><?= TranslateHelper::t('收件人物流号')?></label>
				<div class="col-sm-11">

					<textarea class="form-control" name="track_no_list"
						id="track_no_list"><?= empty($data['track_no'])?"":$data['track_no']?></textarea>
					...
					<table class="table">
						<thead>
							...
							<tr>
								...
								<td><?= $row['nation']?></td>
								<td><?= (!empty($data['listTemplateAddinfo'][$row['template_id']]) && !empty($data['listTemplateAddinfo'][$row['template_id']]['recom_prod']) && $data['listTemplateAddinfo'][$row['template_id']]['recom_prod'] =='Y')?TranslateHelper::t('是'):TranslateHelper::t('否')?></td>
			...
			<div name="div_manual_template"  class="form-group div_template">
				...
				<div class="col-sm-11">
					<textarea class="form-control" name="letter_template" id="letter_template"><?= empty($data['body'])?"":$data['body']?></textarea>
				</div>
			...
			<div style="<?php //echo empty($data['isSameSeller'])?"display:none;":""; ?>display:none;" id="select_recom_group">
