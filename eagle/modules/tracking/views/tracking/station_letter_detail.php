...
/*
 * 
 * <div class="col-sm-6" name="message_history"><?= $this->render('_message_history',['data'=>$data]) ?></div>
	<div class="col-sm-6" name="station_letter"><?= $this->render('_station_letter',['data'=>$data]) ?></div>
