...
$this->title = TranslateHelper::t('等待打印拣货单');
    ...
    <div role="tabpanel" class="tab-pane active" id="home"><br>
    	<div class="inventory-index">
			<ul class="list-unstyled list-inline">
				<li class="content_left"><?= $this->render('//layouts/menu_left_delivery',['warehouse_id'=>$showWarehouseId,'warehouse'=>$warehouseObj]) ?></li> 
