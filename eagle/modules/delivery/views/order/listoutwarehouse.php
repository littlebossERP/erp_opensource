...
<!-- --------批量操作-------------------------------------------------------------------------------------------------- -->
	<div class="pull-left" style="height: 40px;">
		...
		//批量操作 
		$doAction=OrderHelper::getCurrentOperationListNew(OdOrder::STATUS_WAITSEND,'b','出库');
		unset($doAction['setFinished']);
		
		//单独操作
		$doActionOne=OrderHelper::getCurrentOperationListNew(OdOrder::STATUS_WAITSEND,'s','出库');
		?>
