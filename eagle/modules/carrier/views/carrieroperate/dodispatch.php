...
<input type="button" value="交运订单" id="dodispatch" class="btn btn-success" style=" margin-bottom: 10px" >
...
<div class="getOrderNo_order">
	<ul>
		...
		<li class="message2"><?=$orderObj->carrier_error?'上次交运错误信息：<br/>'.$orderObj->carrier_error:''; ?></li> 
	</ul>
</div>
</form>
</div>
