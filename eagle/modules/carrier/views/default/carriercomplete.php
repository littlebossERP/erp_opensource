...
$this->title = TranslateHelper::t('物流已完成');
...
<button type="button" onclick="completecarrier();"  style="height: 28px;" class="btn btn-success btn-sm"><?= TranslateHelper::t('确认发货完成')?></button><span qtipkey="complete_carrier"></span>
 &nbsp;
