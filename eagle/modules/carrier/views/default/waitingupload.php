...
$this->title = TranslateHelper::t('待上传至物流商');
...
<button type="button" id="do-carrier" value='getorderno'  style="height: 28px;" class="btn btn-success btn-sm"><?= TranslateHelper::t('批量上传')?></button>
 &nbsp;
