...
<button type="button" id="do-carrier" value='dodispatch'  style="height: 28px;" class="btn btn-success btn-sm"><?= TranslateHelper::t('批量交运')?></button>
 &nbsp;
...
<table cellspacing="0" cellpadding="0" width="100%" class="table table-hover table-striped" style="font-size: 12px;">
        ...
        <tr>
            ...
            <td>
            <?=isset($services[$data['default_shipping_method_code']])?$services[$data['default_shipping_method_code']]:''; ?><br>
            <?php echo $data['customer_number'];?>
            </td>
            <td>
            <font color="orange"><?php echo strlen($data['carrier_error'])?$data['carrier_error']:'未交运';?></font>
            <?php ?>
            </td>
            <td>
