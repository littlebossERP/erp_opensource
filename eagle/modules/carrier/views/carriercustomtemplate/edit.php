...
// var_dump($template->attributes);die();
?>
<!DOCTYPE html>
<html>
    <!-- START Head -->
    <head>
        ...
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/jquery.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/modernizr.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/jquery-ui.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/jquery-migrate.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/bootstrap.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/core.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/jquery.sparkline.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/app.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/custom.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/jquery.gritter.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/bootbox.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/jwerty.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/base64.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/translate.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/jquery.qtip.min.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/countryselect.js">
        </script>
        <script src="<?= \Yii::getAlias('@web'); ?>/js/project/carrier/customprint/run.js">
        </script>
        ...
        <script type="text/javascript">
	        $(document).ready(function(){
	        	Translator = new Translate('<?=json_encode(TranslateHelper::getJsDictionary()) ?>');

	        	countryselect.NationList=<?=json_encode(@$countrys) ?>;
	        	countryselect.NationMapping=<?=json_encode(@country_mapping) ?>;

	        	<?php 
	        		if(($uid == 1) && ($id == -1)){
				?>
	        			$('.label-type').css('top','73px');
	        			$('.label-set').css('top','73px');
	        	<?php 
					}
				?>
// 	        	countryselect.initNationBox($('div[name=div-select-nation][data-role-id=0]'));
	        });
        </script>
    </head>
    <!--/ END Head -->
    ...
    <body style="overflow:hidden; background:#3a4144 url(/images/customprint/grid_bg_gray.png);">
            ...
            <div class="panel-group nm" id="type-group">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a class="collapsed" href="#addressinfo" data-parent="#type-group" data-toggle="collapse">
                                <span class="arrow mr5"></span>地址信息
                            </a>
                        </h4>
                    </div>
                    <div class="panel-collapse collapse" id="addressinfo">
                        <div class="panel-body">
                            <!---->
                            <div class="dragitem character" data-type="address" data-default-width="150" title="优先显示paypal地址，无paypal地址则显示平台地址">
                                <strong class="title">
                                    <i class="ico-list-alt mr5"></i>收件人地址
                                </strong>
                                <span class="detail">
                                    <span class="name">
                                    ...
                                    <span class="country">
                                        ...
                                        <span class="country_cn" style="display: none;">
                            ...
                            <!---->
                            <div class="dragitem character" data-type="address" data-default-width="150">
                                <strong class="title">
                                    <i class="ico-list-alt mr5"></i>发件人地址
                                </strong>
                                <span class="detail">
                                    <span class="name">
                                    ...
                                    <span class="street">
                                        <littleboss id="SENDER_ADDRESS">Room 605 ,NO.2539,Songhuajiang Road</littleboss>
                                    </span>
                                    <span class="area">
                                        <littleboss id="SENDER_AREA">Hongkou District</littleboss>
                                        <littleboss id="SENDER_CITY">Shanghai</littleboss>
                                        <littleboss id="SENDER_PROVINCE">Shanghai</littleboss>
                                    </span>
                                    <span class="country">
                                        <littleboss id="SENDER_COUNTRY_EN">China</littleboss>
                                        <span class="country_cn" style="display: none;">
                                            (<littleboss id="SENDER_COUNTRY_CN">中国</littleboss>)
                                        </span>
                                    </span>
                                    <span class="postcode">
                                        <littleboss id="SENDER_ZIPCODE">200080</littleboss>
                                    </span>
                                    <span class="tel1">
                            ...
                            <div class="dragitem character" data-type="barcode" data-default-width="142">
                                <strong class="title">
                                    <i class="ico-barcode2 mr5"></i>收件人邮编条码
                                </strong>
                                <span class="detail">
                                    <littleboss id="RECEIVER_ZIPCODE_BARCODE">
                                        <img src="/images/customprint/barcode.jpg">
                                    </littleboss>
                                    <span class="codemunber">
                                        <littleboss id="RECEIVER_ZIPCODE_BARCODE_PREFIX">
                                            <span class="prefix dis-none">
                                            </span>
                                        </littleboss>
                                        <littleboss id="RECEIVER_ZIPCODE">zip434948</littleboss>
                                    </span>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="barcode" data-default-width="142">
                                <strong class="title">
                                    <i class="ico-barcode2 mr5"></i>EUB专用邮编条码
                                </strong>
                                <span class="detail">
                                    ...
                                    <span class="codemunber">
                                        ...
                                        ZIP
                                        <littleboss id="EUB_RECEIVER_ZIPCODE">95501</littleboss>
                                    </span>
                                </span>
                            </div>
                            <!---->
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="200">
                                <strong class="title"><i class="ico-type mr5"></i>发件人手机/电话</strong>
                                <span class="detail">
                                    <littleboss id="SENDER_MOBILE">13811111111</littleboss> / <littleboss id="SENDER_TELEPHONE">021-65343623</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="优先显示paypal地址，无paypal地址则显示平台地址">
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>wish邮收件人国家代码+分拣码</strong>
                                <span class="detail">
                                    <littleboss id="RECEIVER_COUNTRY_EN_NUM_WISH">US22</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>wish邮区别平邮与挂号</strong>
                                <span class="detail">
                                    <littleboss id="UNTRACKED_R_WISH">untracked</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>顺丰俄罗斯国家流向代码</strong>
                                <span class="detail">
                                    <littleboss id="COUNTRY_FLOW_CODE_SFELUOSI">6-EE-RU-G</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>顺丰俄罗斯是否带电</strong>
                                <span class="detail">
                                    <littleboss id="IS_ELECTRIC_SFELUOSI">N</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>收件人国家分区</strong>
                                <span class="detail">
                                    <littleboss id="RECEIVER_COUNTRY_EXPRESS_AREA">1</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>收件人国家分区2</strong>
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="200">
                                <strong class="title"><i class="ico-type mr5"></i>收件人手机/电话</strong>
                                <span class="detail">
                                    <littleboss id="RECEIVER_MOBILE">20178945612</littleboss> / <littleboss id="RECEIVER_TELEPHONE">9258337000</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            ...
                            <div class="dragitem character" data-type="address_mode2" data-default-width="150" title="收件人地址2">
                                <strong class="title">
                                    <i class="ico-list-alt mr5"></i>收件人地址2
                                </strong>
                                <span class="detail">
                                	<span class="company_mode2">
                                        <littleboss id="RECEIVER_COMPANY_MODE2">recipient company;</littleboss>
                                    </span>
                                    <span class="street_mode2">
                                        <littleboss id="RECEIVER_ADDRESS_MODE2">1056 Mornington Lane</littleboss>
                                    </span>
                                    <span class="area_mode2">
                                        <littleboss id="RECEIVER_AREA"></littleboss>
                                        <littleboss id="RECEIVER_COUNTY"></littleboss>
                                        <littleboss id="RECEIVER_CITY">San Ramon</littleboss>
                                        <littleboss id="RECEIVER_PROVINCE">California</littleboss>
                                    </span>
                                    <span class="postcode_mode2">
                                        <littleboss id="RECEIVER_ZIPCODE">94582</littleboss>
                                    </span>
                                    <span class="country_mode2">
                                    	<littleboss id="RECEIVER_COUNTRY_EN">United States</littleboss>
                                    	<littleboss id="RECEIVER_COUNTRY_CN">美国</littleboss>
                                    	<littleboss id="RECEIVER_COUNTRY_EN_AB">US</littleboss>
                                    </span>
                             ...
                             <div class="dragitem character" data-type="character" data-default-width="150" title="收件人详细地址3">
                             	<strong class="title"><i class="ico-type mr5"></i>收件人详细地址3</strong>
                             	<span class="detail">
                             		<littleboss id="RECEIVER_SHENZHEN_ADDRESS_MODE">1056 Mornington Lane,area,county,San Ramon,California,94582,United States,美国,US</littleboss>
                             	</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-collapse collapse" id="orderinfo">
                        <div class="panel-body">
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                ...
                                <span class="detail">
                                    <littleboss id="ORDER_TRADE_NUMBER">
                                        4568779954566
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>订单编号</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_CODE">100000001</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>订单金额（人民币）</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_TOTAL_FEE">
                                        100.00
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>订单金额（原始货币）</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_TOTAL_FEE_ORIGIN">
                                        10.88
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                ...
                                <span class="detail">
                                    <littleboss id="RECEIVER_PAYMENT">
                                        Payment_method
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>实际重量</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_TOTAL_WEIGHT">
                                        100 g
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>预估重量</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_TOTAL_WEIGHT_FORECAST">
                                        90 g
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                ...
                                <span class="detail">
                                    <littleboss id="ORDER_PRINT_TIME">
                                        2015-07-28 11:10:00
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                ...
                                <span class="detail">
                                    <littleboss id="ORDER_PRINT_TIME2">
                                        01/18 13:43:40
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                ...
                                <span class="detail">
                                    <littleboss id="ORDER_PRINT_TIME3">
                                        2015-07-28
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>货运单号</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_EXPRESS_CODE">
                                        CD3390454534
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>包装号</strong>
                                <span class="detail">
                                    <littleboss id="LAZADA_PACKAGE_CODE">
                                            201306072055555015
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>内部单号</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_EXPRESS_INTERNAL_CODE">
                                        CD3390454535
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>实付运费</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_SHIPPING_FEE">
                                        23.5
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>预估运费</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_SHIPPING_FEE_FORECAST">
                                        20.0
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>包材</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_PACKAGE">四号气泡袋</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                            ...
                            <!---->
                            <div class="dragitem character" data-type="barcode" data-default-width="142">
                                <strong class="title"><i class="ico-barcode2 mr5"></i>订单号条码</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_CODE_BARCODE">
                                        <img src="/images/customprint/barcode.jpg">
                                    </littleboss>
                                    <span class="codemunber">
                                        <littleboss id="ORDER_CODE_BARCODE_PREFIX">
                                            <span class="prefix dis-none">
                                            </span>
                                        </littleboss>
                                        <littleboss id="ORDER_CODE">
                                            201306072055562015
                                        </littleboss>
                                    </span>
                                </span>
                            ...
                            <!---->
                             <!---->
                            <div class="dragitem character" data-type="barcode" data-default-width="142">
                                <strong class="title"><i class="ico-barcode2 mr5"></i>包装号条码</strong>
                                <span class="detail">
                                    <littleboss id="LAZADA_PACKAGE_CODE_BARCODE">
                                        <img src="/images/customprint/barcode.jpg">
                                    </littleboss>
                                    <span class="codemunber">
                                        <littleboss id="LAZADA_PACKAGE_CODE_BARCODE_PREFIX">
                                            <span class="prefix dis-none">
                                            </span>
                                        </littleboss>
                                        <littleboss id="LAZADA_PACKAGE_CODE">
                            ...
                            <!---->
                            <div class="dragitem character" data-type="barcode" data-default-width="142">
                                <strong class="title"><i class="ico-barcode2 mr5"></i>货运单号条码</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_EXPRESS_CODE_BARCODE">
                                        <img src="/images/customprint/barcode.jpg">
                                    </littleboss>
                                    <span class="codemunber">
                                        <littleboss id="ORDER_EXPRESS_CODE_BARCODE_PREFIX">
                                            <span class="prefix dis-none">
                                            </span>
                                        </littleboss>
                                        <littleboss id="ORDER_EXPRESS_CODE">
                            ...
                            <!---->
                            <div class="dragitem character" data-type="barcode" data-default-width="142">
                                <strong class="title"><i class="ico-barcode2 mr5"></i>内部单号条码</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_EXPRESS_INTERNAL_CODE_BARCODE">
                                        <img src="/images/customprint/barcode.jpg">
                                    </littleboss>
                                    <span class="codemunber">
                                        <littleboss id="ORDER_EXPRESS_INTERNAL_CODE_BARCODE_PREFIX">
                                            <span class="prefix dis-none">
                                            </span>
                                        </littleboss>
                                        <littleboss id="ORDER_EXPRESS_INTERNAL_CODE">
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>燕文国家分区(平)</strong>
                                <span class="detail">平12&nbsp;&nbsp;&nbsp;A&nbsp;&nbsp;&nbsp;序14</span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="燕文香港国家分区(平)">
                                <strong class="title"><i class="ico-type mr5"></i>燕文香港国家分区(平)</strong>
                                <span class="detail">
                                    1
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="燕文香港国家分区(挂)">
                                <strong class="title"><i class="ico-type mr5"></i>燕文香港国家分区(挂)</strong>
                                <span class="detail">
                                    1
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>燕文国家分区(挂)</strong>
                                <span class="detail">挂12&nbsp;&nbsp;&nbsp;A&nbsp;&nbsp;&nbsp;序14</span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>燕文客户编号</strong>
                                <span class="detail">
                                    <littleboss id="DELIVERY_COMPANY_YANWEN_USERNAME">
                                        144660
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>美国EUB省州分区</strong>
                                <span class="detail">
                                    1
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>线上发货国家分区</strong>
                                <span class="detail">
                                    1
                                </span>
                            </div>
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>美国EUB分拣码</strong>
                                <span class="detail">
                                    <littleboss id="PARTITION_NUMBER_EUB_USA">1F</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>俄速通分拣分区</strong>
                                <span class="detail">
                                    6
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>wish邮分区1</strong>
                                <span class="detail">
                                    1
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>wish邮分区2(挂号)</strong>
                                <span class="detail">
                                    1
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>wish邮分区3</strong>
                                <span class="detail">
                                    1
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>wish邮分区4(平邮)</strong>
                                <span class="detail">
                                    1
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="">
                                <strong class="title"><i class="ico-type mr5"></i>4px联邮通挂号LYT分区号</strong>
                                <span class="detail">
                                    <littleboss id="PARTITION_NUMBER_4PX_LYT_GH">0</littleboss>
                                </span>
                            </div>
                            <!---->
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="">
                                <strong class="title"><i class="ico-type mr5"></i>深圳邮政分区号</strong>
                                <span class="detail">
                                    <littleboss id="PARTITION_NUMBER_SHENZHEN_GH">0</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="线上发货:仓库；4px回邮地址">
                                <strong class="title"><i class="ico-type mr5"></i>扩展字段1</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_PLUS_FIELD_1">扩展字段1</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="线上发货:速卖通物流服务方案；4px销售员代码">
                                <strong class="title"><i class="ico-type mr5"></i>扩展字段2</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_PLUS_FIELD_2">扩展字段2</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="4px客服员代码">
                                <strong class="title"><i class="ico-type mr5"></i>扩展字段3</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_PLUS_FIELD_3">扩展字段3</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="4px产品简称">
                                <strong class="title"><i class="ico-type mr5"></i>扩展字段4</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_PLUS_FIELD_4">扩展字段4</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="4px区域号">
                                <strong class="title"><i class="ico-type mr5"></i>扩展字段5</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_PLUS_FIELD_5">扩展字段5</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="4px国家分区">
                                <strong class="title"><i class="ico-type mr5"></i>扩展字段6</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_PLUS_FIELD_6">扩展字段6</littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150"
                            title="4px客户编号">
                                <strong class="title"><i class="ico-type mr5"></i>扩展字段7</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_PLUS_FIELD_7">扩展字段7</littleboss>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse" id="pickinginfo">
                        <div class="panel-body">
                                    ...
                                    <table id="FULL_ITEMS_DETAIL_TABLE" class="skulist-table min">
                                        <thead style="font-size: 12px; font-family: Arial;">
                                            <tr>
                                                ...
                                                <th class="sku_original dis-none">
                                                    <span>原厂SKU</span>
                                                </th>
                                        ...
                                        <tbody style="font-size: 12px; font-family: Arial;">
                                            <tr id="ITEM_LIST_DETAIL">
                                                ...
                                                <td class="sku_original dis-none">
                                                    <littleboss id="ITEM_LIST_DETAIL_ORIGINAL_SKU">
                                                        <span title="KS0152d100">KS0152d100</span>
                                                    </littleboss>
                                                </td>
                                                ...
                                                <td width="35%" class="name_en dis-none">
                                                    <littleboss id="ITEM_LIST_DETAIL_NAME_EN">
                                                        <span title="Mei red dress in the summer of 2014 new children High quality new flowers veil children's clothes">
                                                            Mei red dress in the summer of 2014 new children High quality new flowers
                                                            veil children's clothes
                                                        </span>
                                                    </littleboss>
                                                </td>
                                                ...
                                                <td colspan="5">
                                                    <p>
                                                        <span class="total-sku pl5">
                                                            <strong>
                                                                <littleboss id="ITEM_LIST_TOTAL_KIND">
                                                                    1
                                                                </littleboss>
                                                            </strong>个商品种类
                                                        </span>
                                                        <span class="total-number pl5">
                                                            <strong>
                                                                <littleboss id="ITEM_LIST_TOTAL_QUANTITY">
                                                                    3
                                                                </littleboss>
                                                            </strong>件商品
                                                        </span>
                                                        <span class="weight pl5 dis-none">重量
                                                            <strong>
                                                                <littleboss id="ITEM_LIST_TOTAL_WEIGHT">
                                                                    548.7
                                                                </littleboss>
                                                            </strong>
                                                        </span>
                                                        <span class="price pl5 dis-none">金额
                                                        	<strong>
                                                                <littleboss id="ITEM_LIST_TOTAL_AMOUNT_PRICE">
                                                                    340.0
                                                                </littleboss>
                                                            </strong>
                                                        </span>
                            ...
                            <!-- ----------------------------------报关信息begin-------------------------------------------
                            -->
                            <div class="dragitem character ui-draggable" data-type="declarelist" data-default-height="119">
                                <strong class="title"><i class="ico-list-alt mr5"></i>报关物品</strong>
                                <div class="detail">
                                    <table id="FULL_ITEMS_DETAIL_TABLE" class="skulist-table declare">
                                        <thead style="font-size: 10px; font-family: Arial;">
                                            <tr>
                                                <th class="name_declare">
                                                    <span>内件详细名称和数量<br>Quantity and detailed description of contents</span>
                                                </th>
                                                <th class="weight_declare" width="65">
                                                    <span>重量(克)<br>Weight(g)</span>
                                                </th>
                                                <th class="price_declare" width="65">
                                                    <span>价值<br>Value</span>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody style="font-size: 12px; font-family: Arial;">
                                            <tr id="ITEM_LIST_DETAIL">
                                                <td class="name_declare sort">
                                                    <span>
                                                        <span class="sort">
                                                            <littleboss id="ITEM_LIST_DECLARE_NAME_CN">儿童用品</littleboss>
                                                        </span>
                                                        <span class="sort_en">
                                                            <littleboss id="ITEM_LIST_DECLARE_NAME_EN">
                                                                children products
                                                            </littleboss>
                                                        </span>
                                                    </span>
                                                </td>
                                                <td class="name_declare group dis-none">
                                                    <span>
                                                        <span class="sku">
                                                            <littleboss id="ITEM_LIST_DETAIL_SKU">
                                                                NY01022
                                                        ...
                                                        <span class="name">
                                                            <littleboss id="ITEM_LIST_DETAIL_NAME_CN">玫红色 2014年夏季新品儿童连衣裙</littleboss>
                                                        </span>
                                                        <span class="name_en dis-none">
                                                            <littleboss id="ITEM_LIST_DETAIL_NAME_EN">
                                                                Mei red dress in the summer of 2014 new children
                                                            </littleboss>
                                                        </span>
                                                        <span class="position dis-none">
                                                            (
                                                            <littleboss id="ITEM_LIST_DETAIL_GRID_CODE">
                                                                2021343-02-12
                                                            </littleboss>
                                                ...
                                                <td class="name_declare custom dis-none">
                                                    <span>自定义内容</span>
                                                </td>
                                                <td width="65" class="weight_declare">
                                                    <littleboss id="ITEM_LIST_DETAIL_WEIGHT">
                                                        <span>
                                                            0.02
                                                        </span>
                                                ...
                                                <td width="65" class="price_declare">
                                                    <littleboss id="ITEM_LIST_DETAIL_AMOUNT_PRICE">
                                                        <span>
                                                            5.0
                                                        </span>
                                        ...
                                        <tfoot style="font-size: 10px; font-family: Arial;">
                                            <tr>
                                                <th class="origin_declare">
                                                    <span>协调系统税则号列和货物原产国(只对商品邮件填写)<br>HS tatiff number and country of origin of goods (For commerical items only)</span>
                                                </th>
                                                <th class="weight_declare">
                                                    <span>总重量<br>Total weight</span>
                                                </th>
                                                <th class="price_declare">
                                                    <span>总价值<br>Total value</span>
                                                </th>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="price_declare">
                                                    <span>
                                                        <littleboss id="ITEM_LIST_TOTAL_AMOUNT_PRICE_DECLARE">
                                                            5.0
                                                        </littleboss>
                                                    </span>
                                                </td>
                            ...
                            <!------------------------------------wish邮 报关信息 begin----------------------------------------->
                            <div class="dragitem character ui-draggable" data-type="declarelist" >
                                <strong class="title"><i class="ico-list-alt mr5"></i>wish邮物品信息</strong>
                                <div class="detail">
                                    <table id="FULL_ITEMS_DETAIL_TABLE" class="skulist-table declare">
                                    <!--<thead style="font-size: 10px; font-family: Arial;">-->
                                        <tr>
                                            <th class="name_declare" width="60%" style="text-align: center;">
                                                <span>description of contents</span>
                                            </th>
                                            <th class="weight_declare" width="20%" style="text-align: center;">
                                                <span>kg</span>
                                            </th>
                                            <th class="price_declare" width="20%" style="text-align: center;">
                                                <span>Val(US $)</span>
                                            </th>
                                        </tr>
                                    <!--</thead>-->
                                        <tbody style="font-size: 12px; font-family: Arial;">
                                        <tr id="ITEM_LIST_DETAIL">
                                            <td class="name_declare sort" style="text-align: left;">
                                                    <span>
                                                        <span class="sort_en">
                                                            <littleboss id="ITEM_LIST_DECLARE_NAME_EN">
                                                                children products
                            ...
                            <!------------------------------------顺丰俄罗斯平邮/挂号 物品信息 begin----------------------------------------->
                            <div class="dragitem character ui-draggable" data-type="declarelist" >
                                <strong class="title"><i class="ico-list-alt mr5"></i>顺丰俄罗斯平邮/挂号物品信息</strong>
                                <div class="detail">
                                    <table id="FULL_ITEMS_DETAIL_TABLE" class="skulist-table declare">
                                        <!--<thead style="font-size: 10px; font-family: Arial;">-->
                                        <tr>
                                            <td class="name_declare" width="64%">
                                                <span>Quantity and detailed description <br/>of contents(1)</span>
                                            </td>
                                            <td class="weight_declare" width="18%">
                                                <span>Weight<br/>(in kg)</span>
                                            </td>
                                            <td class="price_declare" width="18%">
                                                <span>Value(3)</span>
                                            </td>
                                        </tr>
                                        <!--</thead>-->
                                        ...
                                        <tr>
                                            <td class="text-center" style="text-align: left;">
                                                <span>For commercial items only<br/>
                                                      If known,HS HS tariff number(4)<br/>
                                                      and country of origin of goods(5)
                                                </span>
                                            </td>
                                            <td rowspan="2" class="weight_declare">
                                                <span>
                                                    Total weight<br/>(in kg)(6)<br/>
                                                    <littleboss id="ITEM_LIST_TOTAL_WEIGHT">
                                                        0.122
                                                    </littleboss>
                                                </span>
                                            </td>
                                            <td rowspan="2" class="price_declare">
                                                <span>
                                                    Total value(7)<br/>
                                                    <littleboss id="ITEM_LIST_TOTAL_AMOUNT_PRICE_DECLARE">
                                                        6.98
                                        ...
                                        <tr>
                                            <td>
                                                <span style="font-size:small; font-weight: 600;margin-left:7px;">CN</span>
                                            </td>
                                        </tr>
                                        </tfoot>
                                    </table>
                            ...
                            <!------------------------------------顺丰俄罗斯电商专递 物品信息 begin----------------------------------------->
                            <div class="dragitem character ui-draggable" data-type="declarelist">
                                <strong class="title"><i class="ico-list-alt mr5"></i>顺丰俄罗斯电商专递物品信息</strong>
                                <div class="detail">
                                    <table id="FULL_ITEMS_DETAIL_TABLE" class="skulist-table declare" style="width: 99%;">
                                        <!--<thead style="font-size: 10px; font-family: Arial;">-->
                                        <tr>
                                            <td class="name_declare" width="48%">
                                                <span>寄托物</span>
                                            </td>
                                            <td class="weight_declare" width="13%" style="text-align: center;">
                                                <span>重量</span>
                                            </td>
                                            <td class="quantity_declare" width="10%" style="text-align: center;">
                                                <span>数量</span>
                                            </td>
                                            <td class="price_declare" width="17%" style="text-align: center;">
                                                <span>申报价值</span>
                                            </td>
                                            <td class="total_price" width="12%" style="text-align: center;">
                                                <span>总价值</span>
                                            </td>
                                        </tr>
                                        <!--</thead>-->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse" id="productinfo">
                        <div class="panel-body">
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>主SKU编号</strong>
                                <span class="detail">
                                    <littleboss id="PRODUCT_SALE_SKU">
                                        L034665
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>库存SKU编号</strong>
                                <span class="detail">
                                    <littleboss id="PRODUCT_STOCK_SKU">
                                        L034665aL
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>SKU编号2</strong>
                                <span class="detail">
                                    <littleboss id="PRODUCT_SALE_SKU2">
                                        L034665
                                    </littleboss>
                                </span>
                            </div>
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>原厂编号</strong>
                                <span class="detail">
                                    <littleboss id="PRODUCT_ORIGINAL_SKU">
                                        L034665
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                ...
                                <span class="detail">
                                    <littleboss id="PRODUCT_WAREHOUSE_GRID_CODE">
                                        2023214-03-02
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <!---->
                            <div class="dragitem character" data-type="barcode" data-default-width="142">
                                <strong class="title"><i class="ico-barcode2 mr5"></i>库存SKU条码</strong>
                                <span class="detail">
                                    <littleboss id="PRODUCT_STOCK_SKU_BARCODE">
                                        <img src="/images/customprint/barcode.jpg">
                                    </littleboss>
                                    <span class="codemunber">
                                        <littleboss id="PRODUCT_STOCK_SKU_BARCODE_PREFIX">
                                            <span class="prefix dis-none">
                                            </span>
                                        </littleboss>
                                        <littleboss id="PRODUCT_STOCK_SKU">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse" id="element">
                        <div class="panel-body">
                            ...
                            <!---->
                            <div class="dragitem draw" data-type="circletext" data-default-width="50"
                            data-default-height="50">
                                <i class="ico-cc"></i><strong class="title">圆形标记</strong>
                            </div>
                            <!---->
                            <div class="dragitem draw" data-type="onlineimage" data-default-width="50"
                            data-default-height="50">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse" id="imagelibrary">
                        <div class="panel-body">
                            <div class="dragitem image" data-type="image" data-default-width="140"
                            data-default-height="40">
                                <img src="/images/customprint/labelimg/chinapost-1.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="140"
                            data-default-height="70">
                                <img src="/images/customprint/labelimg/chinapost-2.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="125"
                            data-default-height="25">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="140"
                                 data-default-height="40">
                                <img src="/images/customprint/labelimg/SF_eluosi.png" style="width:86% !important;">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="160"
                            data-default-height="80">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="210"
                            data-default-height="65">
                                <img src="/images/customprint/labelimg/pobox.png">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="150"
                            data-default-height="50">
                                <img src="/images/customprint/labelimg/australia-post.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="125"
                            data-default-height="35">
                                <img src="/images/customprint/labelimg/bpostlvs.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="75"
                            data-default-height="25">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="120"
                            data-default-height="45">
                                <img src="/images/customprint/labelimg/esp.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="50"
                            data-default-height="65">
                                <img src="/images/customprint/labelimg/eubauscan.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="120"
                            data-default-height="60">
                                <img src="/images/customprint/labelimg/eubfr.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="55"
                            data-default-height="35">
                                <img src="/images/customprint/labelimg/eubfremail.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="40"
                            data-default-height="50">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="80"
                            data-default-height="100">
                                <img src="/images/customprint/labelimg/eub-postexpres.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="90"
                            data-default-height="50">
                                <img src="/images/customprint/labelimg/HSUUK.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="65"
                            data-default-height="65">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="175"
                            data-default-height="65">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="155"
                            data-default-height="65">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="85"
                            data-default-height="70">
                                <img src="/images/customprint/labelimg/swedishpackets.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="100"
                            data-default-height="92">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="85"
                            data-default-height="30">
                                <img src="/images/customprint/labelimg/wish-mail.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="70"
                            data-default-height="80">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="60"
                            data-default-height="60">
                                <img src="/images/customprint/labelimg/4px3.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="120"
                            data-default-height="55">
                            ...
                            <div class="dragitem image" data-type="image" data-default-width="39"
                            data-default-height="39">
                                <img src="/images/customprint/labelimg/4px_return.gif">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="228"
                            data-default-height="86">
                                <img src="/images/customprint/labelimg/lzd_AS-Poslaju_03.png">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="85"
                            data-default-height="52">
                                <img src="/images/customprint/labelimg/lzd_AS-Poslaju-MY_03.png">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="200"
                            data-default-height="100">
                                <img src="/images/customprint/labelimg/LGS SG1 Logo.png">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="466"
                            data-default-height="203">
                                <img src="/images/customprint/labelimg/LGS TH logo.png">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="105"
                            data-default-height="92">
                                <img src="/images/customprint/labelimg/LGS PH logo.png">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="187"
                            data-default-height="187">
                                <img src="/images/customprint/labelimg/shenzhen_esubao_logo.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="232"
                            data-default-height="233">
                                <img src="/images/customprint/labelimg/shenzhen_esubao_jinji.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="291"
                            data-default-height="291">
                                <img src="/images/customprint/labelimg/shenzhen_esubao_jinji2.jpg">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="115"
                            data-default-height="116">
                                <img src="/images/customprint/labelimg/shenzhen_esubao_biaozhun2.png">
                            </div>
                            <div class="dragitem image" data-type="image" data-default-width="68"
                            data-default-height="145">
                                <img src="/images/customprint/labelimg/shenzhen.png">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-default tab-content">
                ...
                <div class="panel-body tab-pane" id="barcode">
                    ...
                    <div class="codenum-set">
                        ...
                        <div class="form-group">
                            <label class="checkbox-inline semibold">
                                <input type="checkbox" value="" name="" id="codeNumFontWeight" checked>条码代码文字加粗
                            </label>
                        </div>
                        <div class="form-group">
                ...
                <div class="panel-body tab-pane" id="fieldset-address-mode2">
                    <div class="form-group multiple">
                        ...
                        <label class="checkbox-inline semibold">
                            <input type="checkbox" value="country_mode2" name="viewField" checked>显示国家英文，国家中文，国家简码
                        </label>
                    </div>
                    <div class="form-group">
                        <p class="control-label mb5">字段换行设置:</p>
                ...
                <div class="panel-body tab-pane" id="fieldset-sku">
                    ...
                    <div class="form-group">
                        <label class="checkbox-inline semibold">
                            <input type="checkbox" value="sku_original" name="viewField">显示原厂编号
                        </label>
                        <input type="text" id="fieldTextOriginal" class="form-control mt5" name="" value="原厂SKU" disabled>
                    </div>
                    <div class="form-group">
                        <label class="checkbox-inline semibold">
                ...
                <div class="alert alert-warning fade in group-warning">
                    <p class="mb0">
                        文字尺寸小于12px，在使用Google Chrome浏览器可能会出现显示异常，所以我们建议您使用Firefox或IE9以上版本浏览器执行标签打印
                    </p>
                </div>
            </div>
                    ...
                    <form name="frmPrintTemplate" method="post" action="">
                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="loadtext text-muted semibold">
                                            单据类别:
                                            <span class="text-primary pl5 pr10">
                                                <?=$template->template_type ?>
                                            </span>
                                            规格:
                                            <span class="text-primary pl5">
                                                <?=$template->template_width ?>mm×<?=$template->template_height ?>mm
                                            </span>
                            ...
                            <?php
                            	if(($uid == 1) && ($id == -1)){
							?>
                                                国家:<div class=""  name="div-select-nation"  data-role-id="0" style='display:inline-block;'>
								<?=Html::textInput('country_sys',@$_REQUEST['country'],['class'=>'iv-input','placeholder'=>'请选择国家'])?>
							</div>
							<?php
								$shippingMethodCarrierMap[-1] = '通用';
							
									echo Html::textInput('carrier_code_sys',@$_REQUEST['carrier_code_sys'],['style'=>'width:50px;','class'=>'iv-input','placeholder'=>'物流商代码']);
									echo Html::dropDownList('user_cr_template_id','0',$userCrTemplateArr,['class'=>'do eagle-form-control','style'=>'width:100px;','id'=>"user_cr_template_id",'prompt'=>'自定义模板']);
	                            	echo Html::dropDownList('shipping_method_id','',$shippingMethodCarrierMap,['class'=>'do eagle-form-control','style'=>'width:200px;','id'=>"shipping_method_id",'prompt'=>'物流商运输方式']);
	                            	echo Html::dropDownList('lable_type','',$addressListType,['class'=>'do eagle-form-control','id'=>'lable_type','prompt'=>'标签类型']);
	                            	
	                            	echo Html::dropDownList('sys_cr_template_id','0',$sysTemplateArr,['class'=>'do eagle-form-control','style'=>'width:100px;','id'=>"sys_cr_template_id",'prompt'=>'新建系统模板']);
	                           		echo Html::dropDownList('sys_cr_template_open_close','1',array(1=>'开启',0=>'关闭'),['class'=>'do eagle-form-control','style'=>'width:100px;','id'=>"sys_cr_template_open_close",'prompt'=>'开启/关闭']);
                            	?>
                            	<button type="button" class="btn btn-success" id="save-sys-data" ><i class="ico-save mr5"></i>系统模板保存</button>
                            <?php
                            	}else{
                            ?>
                            ...
                            ?>
                                <div class="btn-group">
                                    ...
                                    <ul role="menu" class="dropdown-menu dropdown-menu-left">
                                        <li>
                                            <a href="javascript:void(0);" class="btn-view"><i class="ico-scale-up mr5"></i>预览视图</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" id="printPreview"><i class="ico-print mr5"></i>打印预览</a>
                                        </li>
                                    </ul>
                                </div>
        ...
        <aside class="hotkey-panel">
            <a onclick="$('.hotkey-panel').remove()" data-placement="top" data-original-title="我知道了"
            data-toggle="tooltip" href="javascript:void(0);" class="close-hotkey ico-cancel-circle">
            </a>
            <h3>快捷键</h3>
            <ul>
                <li>
                    <span class="key">
                        <i class="ico-arrow-up3">
                        </i>
                    </span>
        ...
        <aside class="view-panel">
            <div class="btn-group viewpct">
                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                    <i class=" ico-search5 mr5"></i>显示比例:
                    <span class="text pr5 pl5">
                        100%
                    </span>
                    <span class="caret">
                    </span>
                ...
                <ul class="dropdown-menu pull-left copytext" role="menu">
                    <li>
                        <a href="javascript:void(0);" rel="default">
                            100%
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" rel="scale150">
                            150%
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" rel="scale200">
                            200%
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" rel="scale300">
                            300%
                        </a>
                    </li>
                </ul>
        ...
        <form style="display:none;" id="toPreview" action="/carrier/carriercustomtemplate/preview"
        target="_target" method="post">
