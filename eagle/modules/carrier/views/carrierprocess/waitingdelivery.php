...
<div class="form-group">
	<ul class="nav nav-pills"><!-- btn-tab -->
		<li role="presentation" ><input type="button" class ="iv-btn btn-important" onclick="dodispatch()" value="交运" /></li>
		...
		?>
		<li role="presentation" ><?= Html::dropdownlist('do','',$doarr,['class'=>'iv-input','style'=>'width:260px','onchange'=>'movestatus($(this).val());'])?></li>
	</ul>
</div>
	<?php $divTagHtml = "";?>
<table class="table table-condensed table-bordered" style="font-size:12px;table-layout: fixed;word-break: break-all;">
			...
			<tr style="background-color: #f4f9fc" data="<?= $order->order_id?>" deliveryid="<?= $order->delivery_id?>">
				...
				<td class="message"><?= TranslateHelper::t($order->carrier_error)?></td>
				<td>
