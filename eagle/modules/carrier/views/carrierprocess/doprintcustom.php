...
<?php
        ...
        foreach ($data as $order){
        	...
        	foreach ($shippingService->custom_template_print as $type=>$one){
        	    if (empty($one)){continue;}
        	    $template = CrTemplate::findOne($one);
        	    $printData = PrintApiHelper::getPrintData($template, $shippingService, $order , '', '地址单', $carrierConfig);
