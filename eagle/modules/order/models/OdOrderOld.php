...
/**
 * This is the model class for table "od_order_old_v2".
 *
 ...
 */
class OdOrderOld extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['order_id','order_status', 'order_manual_id', 'pay_status', 'shipping_status', 'is_manual_order', 'saas_platform_user_id', 'order_source_srn', 'customer_id', 'order_source_create_time', 'default_warehouse_id', 'paid_time', 'delivery_time', 'create_time', 'update_time', 'carrier_type', 'hassendinvoice','printtime'], 'integer'],
            [['subtotal', 'shipping_cost', 'discount_amount', 'grand_total', 'returned_total', 'price_adjustment'], 'number'],
            [['order_source','order_source_status', 'order_source_order_id', 'order_source_site_id', 'selleruserid', 'source_buyer_user_id', 'order_source_shipping_method', 'consignee', 'consignee_postal_code', 'consignee_phone', 'consignee_email', 'consignee_company', 'consignee_country', 'consignee_city', 'consignee_province', 'consignee_district', 'consignee_county', 'default_carrier_code', 'default_shipping_method_code'], 'string', 'max' => 50],
            ...
            [['user_message', 'seller_commenttext'], 'string', 'max' => 255],
