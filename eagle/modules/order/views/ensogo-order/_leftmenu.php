...
<div id="sidebar">
		<div class="sidebarLv1Title">
			...
			<a  class="" href="<?=Url::to(['/order/ensogo-order/list'])?>"><?= TranslateHelper::t('订单管理')?></a></div>
		</div>
		<ul class="ul-sidebar-one">
			<li class="ul-sidebar-li<?=(empty($_REQUEST['order_status'])&&empty($_REQUEST['is_manual_order']))?' active':''?>">
				<span class="sidebarLv2Title"><a class="" href="<?=Url::to(['/order/ensogo-order/list'])?>"><font><?= TranslateHelper::t('全部订单('.$counter['all'].')')?></font></a></span>
			</li>
			...
			<li class="sidebar-shrink-li">
				<ul class="ul-sidebar-two">
					<li class="ul-sidebar-li<?=(@$_REQUEST['order_status']==OdOrder::STATUS_PAY)?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','order_status'=>OdOrder::STATUS_PAY])?>"><font><?= TranslateHelper::t('已付款')?></font><span class="badge"><?=$counter[OdOrder::STATUS_PAY] ?></span></a>
					</li>
					<li class="ul-sidebar-li<?=(@$_REQUEST['order_status']==OdOrder::STATUS_WAITSEND)?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','order_status'=>OdOrder::STATUS_WAITSEND])?>"><font><?= TranslateHelper::t('发货中')?></font><span class="badge"><?=$counter[OdOrder::STATUS_WAITSEND] ?></span></a>
					</li>
					<li class="ul-sidebar-li<?=(@$_REQUEST['order_status']==OdOrder::STATUS_SHIPPING)?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','order_status'=>OdOrder::STATUS_SHIPPING])?>"><font><?= TranslateHelper::t('已发货')?></font><span class="badge"><?=$counter[OdOrder::STATUS_SHIPPING] ?></span></a>
					</li>
					<li class="ul-sidebar-li<?=(@$_REQUEST['order_status']==OdOrder::STATUS_SHIPPED)?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','order_status'=>OdOrder::STATUS_SHIPPED])?>"><font><?= TranslateHelper::t('已完成')?></font><span class="badge"><?=$counter[OdOrder::STATUS_SHIPPED] ?></span></a>
					</li>
					<li class="ul-sidebar-li<?=(@$_REQUEST['order_status']==OdOrder::STATUS_CANCEL)?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','order_status'=>OdOrder::STATUS_CANCEL])?>"><font><?= TranslateHelper::t('已取消')?></font><span class="badge"><?=$counter[OdOrder::STATUS_CANCEL] ?></span></a>
					</li>
					<li class="ul-sidebar-li<?=(@$_REQUEST['is_manual_order']=='1')?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','is_manual_order'=>'1'])?>"><font><?= TranslateHelper::t('挂起')?></font><span class="badge"><?=$counter['guaqi']?></span></a>
					</li>
				</ul>
			</li>
			<li class="ul-shrinkHead-li">
			...
			<li class="sidebar-shrink-li">
				<ul class="ul-sidebar-two">
					<li class="ul-sidebar-li<?=(@$_REQUEST['exception_status']==OdOrder::EXCEP_HASNOSHIPMETHOD)?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','exception_status'=>OdOrder::EXCEP_HASNOSHIPMETHOD])?>"><font><?= TranslateHelper::t('未匹配到物流')?></font><span class="badge"><?=$counter[OdOrder::EXCEP_HASNOSHIPMETHOD] ?></span></a>
					</li>
					<li class="ul-sidebar-li<?=(@$_REQUEST['exception_status']==OdOrder::EXCEP_SKUNOTMATCH)?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','exception_status'=>OdOrder::EXCEP_SKUNOTMATCH])?>"><font><?= TranslateHelper::t('SKU不存在')?></font><span class="badge"><?=$counter[OdOrder::EXCEP_SKUNOTMATCH] ?></span></a>
					</li>
					<li class="ul-sidebar-li<?=(@$_REQUEST['exception_status']==OdOrder::EXCEP_NOSTOCK)?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','exception_status'=>OdOrder::EXCEP_NOSTOCK])?>"><font><?= TranslateHelper::t('库存不足')?></font><span class="badge"><?=$counter[OdOrder::EXCEP_NOSTOCK] ?></span></a>
					</li>
					<li class="ul-sidebar-li<?=(@$_REQUEST['exception_status']==OdOrder::EXCEP_WAITMERGE)?' active':''?>">
						<a class="" href="<?=Url::to(['/order/ensogo-order/list','exception_status'=>OdOrder::EXCEP_WAITMERGE])?>"><font><?= TranslateHelper::t('待合并')?></font><span class="badge"><?=$counter[OdOrder::EXCEP_WAITMERGE] ?></span></a>
					</li>
				</ul>
			</li>
		</ul>
