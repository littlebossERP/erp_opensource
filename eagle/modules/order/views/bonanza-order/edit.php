...
// 			unset($movearr[300]); 
		...
		<td style="border:1px solid #ddd"><?=Html::dropDownList('default_shipping_method_code',$order->default_shipping_method_code,CarrierApiHelper::getShippingServices())?></td>
...
<div>
	...
	<?php if(in_array($item->sku, BonanzaOrderInterface::getNonDeliverySku())) continue;?>
	<tr>
