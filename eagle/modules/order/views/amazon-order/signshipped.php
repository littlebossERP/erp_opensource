...
<br>
<form action="<?=Url::to(['/order/amazon-order/signshippedsubmit'])?>" method="post">
<table class="table table-striped">
<thead>
<tr>
<th width="5%">平台订单号</th>
<th width="10%">amazon订单号</th>
...
<tbody>
	...
	<td>
		...
		<?php if(!isset($amazonShippingMethod[$method]))$amazonShippingMethod[$method] = $method;?>
		<?=Html::dropDownList("shipmethod[$order->order_id]",$method,$amazonShippingMethod,['prompt'=>'物流服务','style'=>'width:150px;','id'=>'carrier_code','class'=>'eagle-form-control'])?>
	</td>
