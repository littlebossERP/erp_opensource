...
$this->registerJsFile(\Yii::getAlias('@web')."/js/project/order/orderNeweggEdit.js?v=1", ['depends' => ['yii\web\JqueryAsset']]);
$this->registerJsFile(\Yii::getAlias('@web')."/js/project/order/orderEdit.js", ['depends' => ['yii\web\JqueryAsset']]);

$this->title='Newegg订单编辑';
...
<div>
	...
	<tr style="background-color: #fff">
		...
		<td style="border:1px solid #ddd"><?= @$selfneweggOrderStatus[$order->order_status];?></td>
