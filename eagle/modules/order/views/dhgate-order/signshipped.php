...
<br>
<form action="<?=Url::to(['/order/dhgate-order/signshippedsubmit'])?>" method="post">
<table class="table table-striped">
<thead>
<tr>
<th width="5%">平台订单号</th>
<th width="5%">dhgate订单号</th>
...
<tbody>
	...
	<td>
		...
		?>
		<?=Html::dropDownList("shipmethod[$order->order_id]",$method,$dhgateShippingMethod,['prompt'=>'物流服务','style'=>'width:150px;','id'=>'carrier_code','class'=>'eagle-form-control'])?>
	</td>
