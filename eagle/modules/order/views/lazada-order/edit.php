...
$this->registerJsFile(\Yii::getAlias('@web')."/js/project/order/orderLazadaEdit.js?v=1", ['depends' => ['yii\web\JqueryAsset']]);
$this->registerJsFile(\Yii::getAlias('@web')."/js/project/order/orderEdit.js", ['depends' => ['yii\web\JqueryAsset']]);

$this->title='Lazada订单编辑';
...
<div>
	...
	<tr style="background-color: #fff">
		...
		<td style="border:1px solid #ddd"><?= @$selfLazadaOrderStatus[$order->order_status]; //Html::dropDownList('order_status',$order->order_status,$selfLazadaOrderStatus)?></td>
		...
		<td style="border:1px solid #ddd"><?=Html::dropDownList('default_warehouse_i',$order->default_warehouse_id,$warehouses,['onchange'=>'load_shipping_method_for_control(this,"select[name=default_shipping_method_code]")'])?></td>
	</tr>
	</table>
	<br>
	</div>
