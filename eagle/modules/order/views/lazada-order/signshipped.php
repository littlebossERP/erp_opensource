...
$this->registerJsFile(\Yii::getAlias('@web')."/js/project/order/updateShipping.js", ['depends' => ['yii\web\JqueryAsset']]);

$this->title='Lazada订单标记发货';
...
<br>
<form action="<?=Url::to(['/order/lazada-order/signshippedsubmit'])?>" method="post">
<table class="table table-striped">
<thead>
<tr>
<th width="5%">平台订单号</th>
<th width="5%">lazada订单号</th>
...
<tbody>
	...
	<td>
		...
		<?=Html::dropDownList("shipmethod[$order->order_id]",$method,$lazadaShippingMethod,['prompt'=>'物流服务','style'=>'width:150px;','id'=>'carrier_code','class'=>'eagle-form-control'])?>
	</td>
