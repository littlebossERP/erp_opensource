...
$this->registerJsFile(\Yii::getAlias('@web')."/js/project/order/priceministerOrder/offerList.js", ['depends' => ['yii\web\JqueryAsset']]);
...
<div class="tracking-index col2-layout">
	<div class="" style="padding-top: 10px;">
		<div>
			<!-- 搜索区域 -->
			<form class="form-inline" id="form1" name="form1" action="/order/priceminister-order/view-offer-list" method="get" style="float:left;">
			<div style="margin:5px">
				<?=Html::dropDownList('seller_id',@$_REQUEST['seller_id'],$priceministerUsersDropdownList,['class'=>'form-control input-sm','id'=>'seller_id','style'=>'margin:0px','prompt'=>'卖家账号'])?>
				<?php 
