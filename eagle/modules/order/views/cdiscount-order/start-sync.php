...
<form class="form-horizontal" style="width:100%;height:230px;">
    <div class="form-group">
    	<p></p>
        <label for="cd_site_id" class="col-xs-2 col-sm-2 col-lg-2" style="text-align:right;line-height:30px;min-width:80px;">选择店铺</label>
        <div class="col-xs-4 col-sm-4 col-lg-4" style="text-align:left;">
            <select class="p0 form-control" id="cd_site_id" style="margin-top:0;">
                <?php if(count($accounts)> 1): ?>
                    <option value="0">请选择Cdiscount店铺</option>
                <?php endif;?>
        ...
        <div class="col-xs-4 col-sm-4 col-lg-4" style="text-align:left;">
            <input type="date" class="p0 form-control" id="sync_order_time" style="margin-top:0;" value="<?=date("Y-m-d",time()-3600*24) ?>">
        </div>
    </div>
    <div class="form-group">
