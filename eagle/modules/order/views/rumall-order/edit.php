		...
		<div class="order-edit-row">
			...
			<table  class="table table-bordered" style="font-size:12px;border:0px;">
				<tr>
					...
					<td><?=Html::label('Rumall订单状态:',null,['class'=>'edit-order-label'])?></td><td class="text-left"><b style="color:#637c99;"><?=$order->order_source_status?></b></td>
					<!-- 
...
// 						echo Html::button('拆分订单',['onclick'=>"window.location.href='".Url::to(['/order/order/splitorder','orderid'=>$order->order_id])."'"]);
// 					endif;
				endif;?></td>
			</tr>
			<?php 
