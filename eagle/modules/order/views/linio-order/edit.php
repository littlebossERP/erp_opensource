...
$this->registerJsFile(\Yii::getAlias('@web')."/js/project/order/orderLinioEdit.js?v=1", ['depends' => ['yii\web\JqueryAsset']]);
$this->registerJsFile(\Yii::getAlias('@web')."/js/project/order/orderEdit.js", ['depends' => ['yii\web\JqueryAsset']]);

$this->title='Linio订单编辑';
...
<div>
	...
	<tr style="background-color: #fff">
		...
		<td style="border:1px solid #ddd"><?= @$selfLinioOrderStatus[$order->order_status];//Html::dropDownList('order_status',$order->order_status,$selfLinioOrderStatus)?></td>
