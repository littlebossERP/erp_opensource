...
$this->title='Customized订单编辑';
$this->params['breadcrumbs'][] = $this->title;
?>
<form action="" method="post" class="col-xs-12 panel-edit-order">
<div>
	...
	<tr style="background-color: #fff">
		...
		<td style="border:1px solid #ddd"><?= @$selfCustomizedOrderStatus[$order->order_status];?></td>
