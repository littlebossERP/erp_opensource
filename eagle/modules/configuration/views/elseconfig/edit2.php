...
?>
<form id="edit2_fanben_FORM" class="form-inline" method="post" action="/configuration/elseconfig/excelmodel_edit" onsubmit="return docheck()">
...
<div style="height:420px">
	...
	<div  style="margin-top: 60px" class="col col-md-2">
	...
	<?=Html::dropDownList('to','',$showselect,['multiple'=>'multiple','size'=>'20','style'=>'min-width:200px','id'=>'to'])?>
	</div>
</div>
</form>
...
function docheck(){
	...
	if(typeof $('#to option') == undefined || $('#to option').length <= 0){
		$.alert('请先添加需要的数据！','danger');
		return false;
	}
