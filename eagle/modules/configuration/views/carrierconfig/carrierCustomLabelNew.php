						...
						<table class="table table-hover table-striped table-bordered" style="border-top:none">
							<tr class="list-sys-firstTr">
								...
								<th class="text-nowrap col-lg-2">
									<?= TranslateHelper::t('规格')?>
									<?php //HTML::dropDownList('size',empty($size)?'':$size,['100mmX100mm','100mmX50mm','A4 (210mm x 297mm)','80mm x 30mm'],['prompt'=>'规格','onchange'=>'document.search.submit()']) ?>
								</th>
							...
							<?php foreach($systemplates as $systemplate):?>
								<tr>
									  ...
									  <td class="text-nowrap">
										  <div class="btn-group">
											  <a class="btn btn-default btn-sm" href="<?=Url::to(['/configuration/carrierconfig/preview-carrier-template','template_id'=>$systemplate->id,'is_sys'=>1])?>" target="_blank"><span class="glyphicon glyphicon-eye-open"></span><?=TranslateHelper::t('预览') ?></a>
...
<!--	  	<div class="panel panel-default">-->
		    ...
		    <table class="table table-hover table-striped table-bordered" style="border-top:none">
		        ...
		        <tr>
		            ...
		            <td class="text-nowrap">
						<div class="btn-group">
							<a class="btn btn-default btn-sm" href="/configuration/carrierconfig/edit-carrier-template-new?id=<?=$template->template_id ?>" target="_blank"><span class="glyphicon glyphicon-edit"></span><?=TranslateHelper::t('编辑') ?></a>	 
							<a class="btn btn-default btn-sm" href="/configuration/carrierconfig/preview-carrier-template?template_id=<?=$template->template_id ?>" target="_blank"><span class="glyphicon glyphicon-edit"></span><?=TranslateHelper::t('预览') ?></a>
							<button data-ajax-request="/configuration/carrierconfig/delete-carrier-custom-template?template_id=<?=$template->template_id ?>" class="btn btn-danger btn-sm">
								<span class="glyphicon glyphicon-remove"></span> <?=TranslateHelper::t('删除') ?>
							</button>
							
							<a href="#" data-toggle="modal" data-target="#copyToNewTemplate_cus" class="btn btn-success btn-sm" onclick="copytemplateToself_cus(<?= $template->template_id?>,'<?= $template->template_name?>')">
							  <span class="glyphicon glyphicon-copy"></span> <?=TranslateHelper::t('复制为自定义模版') ?>
						  	</a>
						</div>
		            </td>
...
<!--		</div>-->
	...
	<!-- Modal -->
		<div class="modal fade" id="createNewTemplate">
			<form action="edit-carrier-template-new" method="get" target="_blank" class="form-horizontal">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
								...
								<span id="template_name_notice" class="col-lg-offset-9 glyphicon glyphicon-warning-sign"></span>
							</div>
							<div class="form-group">
								...
								<div class="col-lg-5" id="sizeSel">
									...
									<div class="jsDo">
										...
										<div class="input-group" style="display:none;margin-top:5px;">
											<input type="text" class="form-control" name="width" placeholder="宽度" value='100' />
											<span class="input-group-addon" >mm</span>
											<input type="text" class="form-control" name="height" placeholder="高度" value='100' />
											<span class="input-group-addon" >mm</span>
										</div>
									</div>
								</div>
			...
			<input type="hidden" name="template_id" id="template_id">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button class="btn btn-primary" type="button" onclick="docopy('new')" id="template_copy_button">确定</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
						</div>
					</div><!-- /.modal-content -->
				</div><!-- /.modal-dialog -->
		...
		<div class="modal fade" id="copyToNewTemplate_cus">
			<form class="form-horizontal">
			<input type="hidden" name="template_id_cus" id="template_id_cus">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							<h4 class="modal-title">复制自定义模版</h4>
						</div>
						<div class="modal-body">
							<div class="form-group">
								<label for="" class="col-lg-4 control-label">模版名称</label>
								<div class="col-lg-5">
									<input type="text" name="template_name_cus" class="form-control" required="required" />
								</div>
								<span id="template_name_notice" class="glyphicon glyphicon-warning-sign"></span>
							</div>
						</div>
						<div class="modal-footer">
							<button class="btn btn-primary" type="button" onclick="docopy_cus('new')" id="template_copy_button">确定</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
						</div>
					</div><!-- /.modal-content -->
				</div><!-- /.modal-dialog -->
