                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse" id="orderinfo">
                        <div class="panel-body">
                            ...
                            <!---->
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                <strong class="title"><i class="ico-type mr5"></i>LGS店铺名</strong>
                                <span class="detail">
                                    <littleboss id="ORDER_SHOP_LGS_NAME">
                                        lgs_bestsale
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                ...
                                <span class="detail">
                                    <littleboss id="ORDER_PRINT_TIME_YEAR">
                                        2015
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                ...
                                <span class="detail">
                                    <littleboss id="ORDER_PRINT_TIME_MONTH">
                                        01
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="character" data-default-width="150">
                                ...
                                <span class="detail">
                                    <littleboss id="ORDER_PRINT_TIME_DAY">
                                        01
                                    </littleboss>
                                </span>
                            </div>
                            ...
                            <div class="dragitem character" data-type="barcode" data-default-width="142">
                                ...
                                <span class="detail">
                                    ...
                                    <span class="codemunber">
                                        <littleboss id="ORDER_SOURCE_CODE">
                                            1236595
                                        </littleboss>
                                    </span>
                                </span>
...
<!--                             <div class="dragitem image" data-type="image" data-default-width="211" -->
<!--                             data-default-height="122"> -->
<!--                                 <img src="/images/customprint/labelimg/gaoqing_EMS.jpg"> -->
<!--                             </div> -->
<!--                             <div class="dragitem image" data-type="image" data-default-width="211" -->
<!--                             data-default-height="149"> -->
<!--                                 <img src="/images/customprint/labelimg/gaoqing_Parcel.jpg"> -->
<!--                             </div> -->
                        </div>
                    </div>
                </div>
        ...
        <form style="display:none;" id="toPreview" action="/configuration/carrierconfig/preview-carrier-template"
