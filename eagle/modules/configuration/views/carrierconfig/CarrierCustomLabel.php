...
$this->registerJsFile($baseUrl . "js/project/configuration/carrierconfig/CarrierCustomLabel/CarrierCustomLabel.js",['depends' => ['yii\jui\JuiAsset','yii\bootstrap\BootstrapPluginAsset']]);
?>
<style>
...
<!--	  	<div class="panel panel-default">-->
		    ...
		    <table class="table table-hover table-striped table-bordered" style="border-top:none">
		        ...
		        <tr>
		            ...
		            <td class="text-nowrap">
						<div class="btn-group">
							<a class="btn btn-default btn-sm" href="/configuration/carrierconfig/edit-carrier-template?id=<?=$template->template_id ?>" target="_blank"><span class="glyphicon glyphicon-edit"></span><?=TranslateHelper::t('编辑') ?></a>	 
...
<!--		</div>-->
	...
	<!-- Modal -->
		<div class="modal fade" id="createNewTemplate">
			<form action="edit-carrier-template" method="get" target="_blank" class="form-horizontal">
