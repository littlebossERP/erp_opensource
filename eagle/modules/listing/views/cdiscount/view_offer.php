					...
					<?php if(!empty($offer['shipping_information_list'])){
						...
						if(!empty($shipping_info['ShippingInformation'])){
							foreach ($shipping_info['ShippingInformation'] as $i=>$info){
								...
								echo "<td style='text-align:center;padding:5px;'>".round($info['ShippingCharges'] ,2)."</td>";
								echo "<td style='text-align:center;padding:5px;'>".round(['AdditionalShippingCharges'] ,2)."</td>";
								echo "<tr>";
							}	
						}
					}?>
