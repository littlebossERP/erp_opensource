...
<form class="form-horizontal" style="width:550px;height:230px;">
    <div class="form-group">
        <label for="ensogo_modal_site_id" class="col-xs-2 col-sm-2 col-lg-2" style="text-align:right;line-height:30px;min-width:80px;">选择店铺</label>
        <div class="col-xs-4 col-sm-4 col-lg-4" style="text-align:left;">
            <select class="p0 form-control" id="ensogo_modal_site_id" style="margin-top:0;">
                <?php if(count($accounts)> 1): ?>
                    <option value="0">请选择Ensogo店铺</option>
                <?php endif;?>
