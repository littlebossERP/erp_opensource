...
$this->title = TranslateHelper::t("Linio下架商品列表");
?>
<style>
.table td{
...
<div class="linio-listing linio-listing-online-product">
	<div class="search">
	<form action="/listing/linio/off-shelf-product" method="POST" id="put_off_search">
		...
		<input type="button" class="btn btn-default btn-sm" value="同步商品" data-toggle="modal" data-target="#Sync_product" onclick="linioListing.reset()">
		<input type="button" class="btn btn-default btn-sm" value="批量上架" onclick="linioListing.batchPutOn()">
	</form>
	</div>
			...
			<thead>
			 ...
			 ?>
				<tr data-id="<?php echo $parent_product['id']?>" class="striped-row">
					...
					<a title="上架" onclick="linioListing.parentProductPutOn(this)"><span class="iconfont icon-piliangshangjia"></span></a>
					</td>
				</tr>
				...
				<tr class="detail_product product_<?php echo $parent_product['id']?> variation_tr <?php echo $num%2==1?"striped-row":null;$num++;?>" data-productid="<?php echo $detail_product['id']?>" style="display: none" >
					...
					<?php endif;?>
					<td class="table-operate-style">
					<a title="上架" onclick="linioListing.productPutOn(<?php echo $detail_product['id']?>)"><span class="iconfont icon-piliangshangjia"></span></a>
					</td>
				</tr>
				<?php endforeach;?>
			 <?php endforeach;?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <input id="Sync_product_comfirm" value="确认" type="button" class="btn btn-primary" onclick="linioListing.SyncSubmit()">
