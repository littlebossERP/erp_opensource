...
$menu = [
	[
		...
		'items'=>[
			...
			[
			'name'=>'发布中',
			'action'=>'jumia-listing/publishing'
			],
			[
			'name'=>'发布失败',
			'action'=>'jumia-listing/publish-fail'
			],
// 			[
// 				'name'=>'发布成功',
// 				'action'=>'jumia-listing/publish-success',
// 				'badge'=>0
// 			]
		]
	],
    ...
    'items'=>[
        ...
        [
        'name'=>'下架商品',
				'action'=>'jumia/off-shelf-product',
        'badge'=>0
        ]
    ],
    	],
