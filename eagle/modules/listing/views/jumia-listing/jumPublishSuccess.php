...
$this->title = TranslateHelper::t("Jumia发布成功列表");
?>
...
?>
<div class="col2-layout jumia-listing jumia-listing-publish-succcess">
        <div class="search">
        <form action="/listing/jumia-listing/publish-success" method="GET">
