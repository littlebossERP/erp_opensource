...
$this->title = TranslateHelper::t("lazada下架商品列表");
?>
...
?>
<div class="col2-layout lazada-listing lazada-listing-offline-product">
        <div class="search">
        <form action="/listing/lazada/off-shelf-product" method="POST" id="put_off_search">
            ...
            <br />
            <button class="btn btn-info operate-button" type="button" data-toggle="modal" data-target="#Sync_product" onclick="lazadaListing.reset()"><span class="iconfont icon-tongbuzhong1"></span> 同步商品</button>
            <button class="btn btn-info operate-button" type="button" onclick="lazadaListing.batchPutOn()"><span class="iconfont icon-piliangshangjia"></span> 批量上架</button>
        </form>
        </div>
...
//                  }
                 ...
                 ?>
                    <tr data-id="<?php echo $parent_product['id']?>" class="striped-row">
                        ...
                        <a title="上架" onclick="lazadaListing.parentProductPutOn(this)"><span class="iconfont icon-piliangshangjia"></span></a>
                        </td>
                    </tr>
                    ...
                    <tr class="detail_product product_<?php echo $parent_product['id']?> variation_tr <?php echo $num%2==1?"striped-row":null;$num++;?>" data-productid="<?php echo $detail_product['id']?>" style="display: none" >
                        ...
                        <?php endif;?>
                        <td class="table-operate-style">
                        <a title="上架" onclick="lazadaListing.productPutOn(<?php echo $detail_product['id']?>)"><span class="iconfont icon-piliangshangjia"></span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
                 <?php endforeach;?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-style">
      ...
      <div class="modal-footer">
        <input id="Sync_product_comfirm" value="确认" type="button" class="btn btn-success" onclick="lazadaListing.SyncSubmit()">
