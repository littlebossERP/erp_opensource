...
if(!empty($_REQUEST['template_id']))
	$tempalteId = $_REQUEST['template_id'];
else	
	$tempalteId = 0;
?>
<style type="text/css">
...
<!-- <div>
		<div style="margin-top: 10px;">
			<button type="button" class="btn btn-info showall" style="width: 100px;">图片上传预览</button>
		</div>
		<div style="margin-top: 10px;" class="handle">
			<button type="button" class="btn btn-success" style="width: 100px;">保存</button>
		</div>
		<div style="margin-top: 10px;" class="handle">
			<button type="button" class="btn btn-default" style="width: 100px;">退出</button>
		</div>
</div> -->
<!-- <div id='butset'>
<?php if(!empty($_REQUEST['template_id'])):?>
	<div id="save" style="margin-top: 10px;" class="handle">
			<button type="button" class="btn btn-success" style="width: 100px;">保存</button>
	</div>
<?php endif;?> 
	<div style="margin-top: 10px;">
...
<?php endif;?>
	<div class="saveas" style="margin-top:10px;margin-left:-6px;" href='#' title='Save As'>
	<button type="button" class="btn btn-success" style="width: 100px;" alt='save_as'>另存为</button>
	</div> 
<?php if(!empty($_REQUEST['template_id'])):?>
...
<div id="branch" style="display:none;overflow-y:auto;">
		<table>
			...
			<table style="background:#eee;margin-left:20px;">
				...
				<tr>
					<td colspan=3>
						<div id="bg_P" style="display: none;"><input
										type="text" style="width: 180px;margin-right: -20px;" class="font8 yanse" 
										name="tb_eb_CFI_style_master_background_Pattern"
										id="tb_eb_CFI_style_master_background_Pattern"
										value='<?php echo $allItem['tb_eb_CFI_style_master_background_Pattern']?>'/>
											...
											<table>
												...
												<tr>
													<td style='width: 200px;'><label style='width: 260px;'> <input
														...
														style='background-image: url("<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern1.png"); width: 200px; height: 25px; display: inline-block;margin-top: 10px;'></a>
													</label></td>
												</tr>
												...
												<tr>
													...
													Pattern style 2 <a
														style='background-image: url("<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern2.png"); width: 200px; height: 25px; display: inline-block;margin-top: 10px;'></a>
													</label></td>
												</tr>
<!--  -->
												<!-- <tr>
												...
												<tr>
													...
													Pattern style 4 <a
														style='background-image: url("<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern4.png"); width: 200px; height: 25px; display: inline-block;margin-top: 10px;'></a>
													</label></td>
												</tr>
												...
												<tr>
													...
													Pattern style 5 <a
														style='background-image: url("<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern5.png"); width: 200px; height: 25px; display: inline-block;margin-top: 10px;'></a>
													</label></td>
												</tr>
												...
												<tr>
													...
													Pattern style 6 <a
														style='background-image: url("<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern6.png"); width: 200px; height: 25px; display: inline-block;margin-top: 10px;'></a>
													</label></td>
												</tr>
												...
												<tr>
													...
													Pattern style 7 <a
														style='background-image: url("<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern7.png"); width: 200px; height: 25px; display: inline-block;margin-top: 10px;'></a>
													</label></td>
												</tr>
												...
												<tr>
													...
													Pattern style 8 <a
														style='background-image: url("<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern8.png"); width: 200px; height: 25px; display: inline-block;margin-top: 10px;'></a>
													</label></td>
												</tr>
												...
												<tr>
													...
													Pattern style 9 <a
														style='background-image: url("<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern9.png"); width: 200px; height: 25px; display: inline-block;margin-top: 10px;'></a>
													</label></td>
												</tr>
												...
												<tr>
													...
													Pattern style 10 <a
														style='background-image: url("<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern10.png"); width: 200px; height: 25px; display: inline-block;margin-top: 10px;'></a>
													</label></td>
												</tr>
											</table>
											</td>
	...
	<div  style="margin-top:10px;margin-left:-6px;" href='#' title='Save'>
		<button class="save btn baocun" type="button" style="width: 200px;margin-left: 25px;border: 1px solid;line-height: 0.5;background-color:#fff; " alt='save'>保存</button>
	</div>
		<table class="moban">
			<tr>
				<td>
			...
			<table style="background:#eee;margin-left:20px;width:200px">
				...
				<tr>
					<td>
						...
						<span class="iconfont icon-tanchushezhi detail SNBanner" name='SNBanner'></span>
					</td>
				</tr>
				<tr>
					<td>
			...
			<table style="background:#eee;margin-left:20px;margin-bottom:20px;">
				...
				<tr id="Pg_P" class="" style="display: none;">
									<td colspan=3><input type='text' style="margin-left:5px;width:180px;margin-top: 10px;margin-right: -20px;" name='eb_tp_policy_Pattern'
										...
										value='<?php echo $allItem['eb_tp_policy_Pattern']?>' />&nbsp;<a style="color: black;" 
...
<div id="branch1" style="display:none;overflow-y: auto;">
					...
					<td>
						...
						<div id="infobox_bkgd_type_p" style="display:none;">
							<input
								...
								class='in80 infodetclass' style="width:150px;margin-left:10px;" value='<?php echo $allItem['infobox_bkgd_pattern']?>' />&nbsp;<a style="color:black;" 
	...
	<button class="save btn baocun" type="button" style="width: 200px;margin-left: 25px;border: 1px solid;line-height: 0.5;background-color:#fff; " alt='save'>保存</button>
		...
		<table style="margin-top:10px;">
			...
			<tr>
				<td colspan=4>
					<form id='sortablef'>
					<ul id="sortable" style="margin-left:45px;">
						<?php
						$sortableMap = array();
						$content_sort_arr = array();
						if(!empty($sortable)){
							$index = 0;
							foreach ($sortable as $value){
								if($value['name'] == 'content_type_id')
									$index++;
								$sortableMap[$index][$value['name']] = $value['value'];
							}
							foreach ($sortableMap as $value){
								$content_sort_arr[$value['content_displayorder']] = $value;
							}
						}
						?>
					<?php if(!empty($content_sort_arr)):?>
							<?php foreach ($content_sort_arr as $index=>$content_sort):?>
								<?php
								if(!isset($content_sort['content_type_id']))$content_sort['content_type_id'] = "";
								if(!isset($content_sort['content_text']))$content_sort['content_text'] = "";
								if(!isset($content_sort['content_displayorder']))$content_sort['content_displayorder'] = "";
								if(!isset($content_sort['content_target_display_mode']))$content_sort['content_target_display_mode'] = "";
								if(!isset($content_sort['infobox_content']))$content_sort['infobox_content'] = "";
								?>

					    <li class='sort infono<?php echo $index;?> delinfono<?php echo $index;?>'>
						<table class='info7 infono' style="background:#eee;margin-left:-30px;width:200px;margin-bottom:20px">
							<tr class='font8'>
								<td><span class="block">功能框种类:</span></td>
								<td><a class='btn_del' href='#' id='no<?php echo $index;?>'></a></td>
							</tr>
							<tr class="font8">
								<td><input type='text' class='content_type_id'
									name='content_type_id' value='<?php echo $content_sort['content_type_id'];?>' readonly='readonly' /></td>
							</tr>
							<tr class='font8'>
							...
							<tr class="font8">
								<td><input type='text' class='content_text in110'
									name='content_text' value='<?php echo $content_sort['content_text'];?>' /></td>
								<?php if("picture" == strtolower($content_sort['content_type_id'])):?>

								<td><span class='pic_details iconfont icon-tanchushezhi' title='Edit Detail' id='content<?php echo $index;?>'
									href='#'></span></td>

								<?php elseif("text.link" == strtolower($content_sort['content_type_id'])) :?>
								<td><span class="text_details iconfont icon-tanchushezhi" title='Edit Detail' id='content<?php echo $index;?>' href='#'></span></td>

								<?php elseif("store cat." == strtolower($content_sort['content_type_id'])) :?>
								<td><span class="cat_details iconfont icon-tanchushezhi" title='Edit Detail' id='content<?php echo $index;?>' href='#'></span></td>

								<?php elseif("flash" == strtolower($content_sort['content_type_id'])) :?>
								<td><span class="flash_details iconfont icon-tanchushezhi" title='Edit Detail' id='content<?php echo $index;?>' href='#'></span></td>

								<?php elseif("youtube" == strtolower($content_sort['content_type_id'])) :?>
								<td><span class="youtube_details iconfont icon-tanchushezhi" title='Edit Detail' id='content<?php echo $index;?>' href='#'></span></td>

								<?php endif;?>
							</tr>
							
							<td class='disno'>
								<input type='number' class='content_displayorder' name='content_displayorder' value='<?php echo $content_sort['content_displayorder']?>' />
								<input type='text' class='content_target_display_mode' name='content_target_display_mode' value='<?php echo isset($content_sort['content_target_display_mode'])?$content_sort['content_target_display_mode']:"";?>' />
								<input type='text' class='infobox_content' name='infobox_content' name='infobox_content' id='addcontent<?php echo $index;?>' value='<?php echo isset($content_sort['infobox_content'])?$content_sort['infobox_content']:"";?>' />
							</td>
							</tr>
						</table>
						</li>
	...
	<button class="save btn baocun" type="button" style="width: 200px;margin-left: 25px;border: 1px solid;line-height: 0.5;background-color:#fff; " alt='save'>保存</button>
		...
		<div>
			<p class="hezi">拉动盒子以改动在工具列的显示次序</p>
		</div>
...
<div id="branch2" style="display:none;overflow-y: auto;">
	...
	<table>
			<tr>
				<td style="padding-left: 8px;"><p style="margin-top:30px;margin-left:20px">产品描述部分</p></td>
				...
				<tr>
					<td>
						<input type="text" id="eb_tp_font_Title"
								name="eb_tp_font_Title" class="FS_Auto yanse" value="Impact" style="width:150px;" />
					</select>
					</td>
				</tr>
				<tr>
	...
	<button class="save btn baocun" type="button" style="width: 200px;margin-left: 25px;border: 1px solid;line-height: 0.5;background-color:#fff " alt='save'>保存</button>
		...
		<table style="margin-top: 30px;">
			...
			<table style="background:#eee;margin-left:20px;margin-bottom:20px;width:200px;">
				...
				<tr>
					<td>
						<select name='d_infobox_type_id' id='d_infobox_type_id' style="margin-bottom:20px;width:100px;" class="yanse">
...
<!--							<option value="item_specifics">Item Specifics</option>-->
			...
			<tr>
				<td colspan=4>
					<form id="dsortablef">
						<ul id="dsortable" style="margin-left:45px;">
						<?php 
						
							$dsortableMap = array();
							$d_content_sort_arr = array();
							if(!empty($dsortable)){
								$index = 0;
								foreach ($dsortable as $value){
									if($value['name'] == 'd_content_type_id')
										$index++;
									$dsortableMap[$index][$value['name']] = $value['value'];
								} 
								foreach ($dsortableMap as $value){
									$d_content_sort_arr[$value['d_content_displayorder']] = $value;
								}
							}
							
						?>
						<?php if(!empty($d_content_sort_arr)):?>
						<?php foreach ($d_content_sort_arr as $index=>$d_content_sort):?>
						<?php 
						if(!isset($d_content_sort['d_content_type_id']))$d_content_sort['d_content_type_id'] = "";
						if(!isset($d_content_sort['d_content_text']))$d_content_sort['d_content_text'] = "";
						if(!isset($d_content_sort['d_content_pos']))$d_content_sort['d_content_pos'] = "";
						if(!isset($d_content_sort['d_content_width']))$d_content_sort['d_content_width'] = "";
						if(!isset($d_content_sort['d_content_align']))$d_content_sort['d_content_align'] = "";
						if(!isset($d_content_sort['d_content_displayorder']))$d_content_sort['d_content_displayorder'] = "";
						if(!isset($d_content_sort['d_infobox_content']))$d_content_sort['d_infobox_content'] = "";
						if(!isset($d_content_sort['d_infobox_en_key']))$d_content_sort['d_infobox_en_key'] = "";
						?>
							<li class='dsort infono1 delinfodno<?php echo $index;?>' style="background:#eee;margin-left:-30px;width:200px;margin-bottom:20px">
							<table class='info7 infono'>
								<tr class='font8'>
									<td><span class="block">功能框种类:</span></td>
									<td><a class='btn_del' href='#' id='dno<?php echo $index;?>'></a></td>
								</tr>
								<tr class="font8">
									<td><input type='text' class='d_content_type_id in110'
										name='d_content_type_id' value='<?php echo $d_content_sort['d_content_type_id'];?>'
								...
								<tr class="font8">
									<td><input type='text' class='d_content_text in110' name='d_content_text'
										value='<?php echo $d_content_sort['d_content_text'];?>' /></td>
									<!-- <td><a class='d_desc_details detail' name='d_desc_details'
										title='Edit Detail' id='content<?php echo $index;?>' href='#'><img
										src='/images/ebay/template/edit_property.png' alt='create_info'
										height='16' height='16'></a>
									</td> -->
									<?php if("basic descriptions" == strtolower($d_content_sort['d_content_type_id'])):?>

									<td><span class='d_desc_details detail iconfont icon-tanchushezhi' name='d_desc_details' title='Edit Detail' id='content<?php echo $index;?>'
										href='#'></span></td>

									<?php elseif("item specifics" == strtolower($d_content_sort['d_content_type_id'])) :?>

									<td><span class="d_item_details detail iconfont icon-tanchushezhi" title='Edit Detail' name="d_item_details" id='content<?php echo $index;?>' href='#'></span></td>
									<?php endif;?>
								</tr>
								<tr class='font8'>
								...
								<tr class="font8">
									<td><select class='d_content_pos in110' name='d_content_pos'>
										<option value='above_product_Photo' <?php if($d_content_sort['d_content_pos'] == "above_product_Photo" ) echo "selected" ;?>>Above Product Photo</option>
										<?php if( 'EagleGallery' != $d_content_sort['d_content_type_id'] ):?>
										<option value='Next_to_Product_Photo' <?php if($d_content_sort['d_content_pos'] == "Next_to_Product_Photo" ) echo "selected" ;?>>Next to Product Photo</option>
										<?php endif;?>
										<option value='Below_All_Product_Photo' <?php if($d_content_sort['d_content_pos'] == "Below_All_Product_Photo" ) echo "selected" ;?>>Below All Product Photo</option>
									</select></td>
								</tr>
								...
								<tr class="font8">
									<td><select class='d_content_width r80 in110' name='d_content_width' style="width:180px;margin-left:10px">
										<option value='1/2' <?php if($d_content_sort['d_content_width'] == "1/2" ) echo "selected" ;?>>1/2 width</option>
										<option value='1/3'  <?php if($d_content_sort['d_content_width'] == "1/3" ) echo "selected" ;?>>1/3 width</option>
										<option value='2/3'  <?php if($d_content_sort['d_content_width'] == "2/3" ) echo "selected" ;?>>2/3 width</option>
										<option value='1/4'  <?php if($d_content_sort['d_content_width'] == "1/4" ) echo "selected" ;?>>1/4 width</option>
										<option value='2/4'  <?php if($d_content_sort['d_content_width'] == "2/4" ) echo "selected" ;?>>2/4 width</option>
										<option value='3/4' <?php if($d_content_sort['d_content_width'] == "3/4" ) echo "selected" ;?>>3/4 width</option>
									</select><select class='d_content_align in110' name='d_content_align' style="width:180px;margin-left:10px">
										<option value='left' <?php if($d_content_sort['d_content_align'] == "left" ) echo "selected" ;?>>左边</option>
										<option value='center' <?php if($d_content_sort['d_content_align'] == "center" ) echo "selected" ;?> >置中</option>
										<option value='right'  <?php if($d_content_sort['d_content_align'] == "right" ) echo "selected" ;?>>右边</option>
									</select></td>
								</tr>
								<tr class='font8'>
									<td class='disno'>
									<input type='number' class='d_content_displayorder' name='d_content_displayorder' value='<?php echo $d_content_sort['d_content_displayorder'];?>' />
									<input type='text' class='d_infobox_content' name='d_infobox_content' id='d_addcontent1' value="<?php echo $d_content_sort['d_infobox_content'];?>" />
									<input type='text' class='d_infobox_en_key' name='d_infobox_en_key' value='<?php echo $d_content_sort['d_infobox_en_key'];?>'></td>
								</tr>
							</table>
							</li>
							<?php endforeach;?>
		...
		<table>
			<tr>
				<td style="padding-left: 8px;">
					<label>
						<p style="margin-left: 20px;margin-top: 10px;width:180px;">功能模块</p>
					</label>
				</td>
				<td>
							...
							<?php 
								...
								if(!empty($msortable)){
									...
									foreach ($msortableMap as $value){
										$m_content_sort_arr[$value['m_content_displayorder']] = $value;
									}
								}
							?>
							<?php if(!empty($m_content_sort_arr)):?>
							<?php foreach ($m_content_sort_arr as $index=>$m_content_sort):?>
							<?php 
								if(!isset($m_content_sort['m_content_type_id']))$m_content_sort['m_content_type_id'] = "";
								if(!isset($m_content_sort['m_content_text']))$m_content_sort['m_content_text'] = "";
								if(!isset($m_content_sort['m_content_displayorder']))$m_content_sort['m_content_displayorder'] = "";
								if(!isset($m_content_sort['m_content_target_display_mode']))$m_content_sort['m_content_target_display_mode'] = "";
								if(!isset($m_content_sort['m_infobox_content']))$m_content_sort['m_infobox_content'] = "";
								if(!isset($m_content_sort['m_infobox_en_key']))$m_content_sort['m_infobox_en_key'] = "";
							?>						
							<li class='msort infono<?php echo $index;?> delinfomobileno<?php echo $index;?>' style="background:#eee;margin-left:-30px;width:200px;margin-bottom:20px">
							<table class='info7 infono'>
								<tr class='font8'>
									<td><span class="block">功能框种类:</span></td>
									
									<td><a class='btn_del' href='#' id='mobileno<?php echo $index;?>'></a></td>
								</tr>
								<tr class="font8">
									<td><input type='text' class='m_content_type_id in110'
										name='m_content_type_id' value='<?php echo $m_content_sort['m_content_type_id'];?>'
										readonly='readonly' /></td>
								</tr>
								<tr class='font8'>
									<td><span class="block">功能框标题:</span></td>
								...
								<tr class="font8">
									<td><input type='text' class='m_content_text in110'
										name='m_content_text' value='<?php echo $m_content_sort['m_content_text'];?>' /></td>
								</tr>
								<tr>
								<td class='disno'>
									<input type='number' class='m_content_displayorder' name='m_content_displayorder' value='<?php echo $m_content_sort['m_content_displayorder'];?>' />
									<input type='text' class='m_content_target_display_mode' name='m_content_target_display_mode' value='<?php echo $m_content_sort['m_content_target_display_mode'];?>' />
									<input type='text' class='m_infobox_content' name='m_infobox_content' id='m_addm_content<?php echo $index;?>' value='<?php echo $m_content_sort['m_infobox_content'];?>' />
									<input type='text' class='m_infobox_en_key' name='m_infobox_en_key' value='<?php echo $m_content_sort['m_infobox_en_key'];?>'>
								</td>
								</tr>
							</table>
							</li>
		...
		<table style='background:#eee;margin-left:30px;width:200px;margin-bottom:20px'>
			...
			<tr>
				<td>
					...
					<div  style="margin-top:10px;margin-left:-6px;" href='#' title='Save'>
	<button class="save btn baocun" type="button" style="width: 200px;margin-left: 35px;border: 1px solid;line-height: 0.5;background-color:#fff " alt='save'>保存</button>
	</div> 
			<tr>
				<td>
	...
	<table>
			...
			<div style="margin-left: 10px;">			   
				...
				<div>
					...
					<!-- <div style="margin-left:210px;margin-top: -250px;">
					...
					<tr tab-view="tab" tab-id="tab1" id="attr_t_b_div_p">
						<td>
							<input type="text" name="" id="theme" style="margin-left: 10px;width:200px;" class="in170 infodetclass noneishide" data-noneishide="attr_t_b_div_p" value="<?php echo \Yii::$app->urlManager->hostInfo.Yii::$app->urlManager->baseUrl ;?>/images/ebay/template/pattern1.png">	
								<a name="backgroundPattern" class="tip" role="button" aria-disabled="false" style="color: black;">
