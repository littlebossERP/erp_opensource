...
<style type='text/css'>
    ...
    #Below_All_Product_Photo,#Below_All_Product_Posters,#above_product_Photo,.MM_h_desc,#desc_html,#feedback_html,#poster_html,#tabContainer,#policy_html
    {
        width: 800px;
        margin: auto;
        text-align: center;
        ...
        <tr>
            ...
            if(!empty($dsortable)){
                ...
                foreach ($groupDsortableInfo as $dContent){
                    ...
                    $contentTypeDContentMap[$d_content_type[$dContent['d_content_type_id']]] = $dContent;
                }
                    ...
                    <div id="above_product_Photo" class="desc_word ">
                        ...
                        if(isset($displayDsortable) && isset($displayDsortable['above_product_photo'])){
                            foreach ($displayDsortable['above_product_photo'] as $d_content_type){
                                echo $this->renderFile($fileRoot.'itemPartialHtml'.$fileExt, array("finalHtml"=>$finalHtml,"contentType"=>$d_content_type , "dContent"=>$contentTypeDContentMap[$d_content_type],"itemInfo"=>$itemInfo,'allItem'=>$allItem));
                            }
                        }
                        ?>
                    </div>
                        ...
                        <table>
                            <tr>
                                <?php if(!empty($itemInfo['imagesUrlArr'])):?>
                                    <td id='Bwidht' class='product_photo_need_hide'>
                                        <div id='big_pic'>
                                            <div class='bigimage'>
                                                <div id='gallery'><a
                                                        href='<?php echo $itemInfo['imagesUrlArr'][0];?>'
                                                        id='linkId'> <img alt='' border='0' id='sample_Bigimg'
                                                                          width='400PX'
                                                                          src='<?php echo $itemInfo['imagesUrlArr'][0];?>'
                                        ...
                                        <div id='smail_pic_box' style='float: left;font-size: 0;'>
                                            <?php foreach ($itemInfo['imagesUrlArr'] as $index=>$prodSrc):?>

                                                <div class='smail_pic smail_pic<?php echo $index;?>'>
                                                    <a class='mousedown' id='MD<?php $index;?>'
                                                       onmousedown='changeImages("<?php echo $prodSrc;?>")'>
                                                        <img alt='' class='sm0' width='70px'
                                                             src='<?php echo $prodSrc;?>'>
                                                    </a>
                                                </div>
