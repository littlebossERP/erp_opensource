...
<tr ><td>Youtube Link</td><td><input type='text' class='content_src_url in200' value='Payment Policy'  /></td><td><a class='inbtn_del' id='pictable1' href='#'></a></td></tr>
</table></div>
 <Script>
  $(function() {
	...
	$('#'+$( this ).attr('name')).append("<table class='pictable infopictable"+n+"'><tr ><td>Youtube Link</td><td><input type='text' class='content_src_url in200' value=''  /></td><td><a class='inbtn_del' id='pictable"+n+"'></a></td></tr></table>");
						return false;
					  });
					  });
