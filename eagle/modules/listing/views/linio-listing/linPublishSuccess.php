...
$this->title = TranslateHelper::t("Linio发布成功列表");
?>
<?php 
...
?>
<div class="col2-layout linio-listing linio-listing-publish-succcess">
        <div class="search">
        <form action="/listing/linio-listing/publish-success" method="GET">
