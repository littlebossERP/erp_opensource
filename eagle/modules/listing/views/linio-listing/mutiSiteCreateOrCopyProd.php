...
$this->registerCssFile ( \Yii::getAlias('@web') . '/css/listing/linioListing.css' );
...
$this->registerJsFile(\Yii::getAlias('@web')."/js/project/listing/linio_listing.js", ['depends' => ['yii\web\JqueryAsset']]);
...
<div class="col2-layout linio-listing linio-listing-create-or-edit ">
		<div class="col-lg-11" id="all_info">
		    <!--共有信息-->
		    <div id="store-info" class="panel panel-default form-horizontal form-bordered min search-info">
                <div class="panel-heading">
                    <div style="display: none;">
					    ...
					    <input type="hidden" id="linioId" name="linioId" value='<?php echo isset($lin_uid)?$lin_uid:'';?>'>
					    <input type="hidden" id="copyType" name="copyType" value="mutiCopy">
                    </div>
                    <h3 class="panel-title"><i class="ico-file4 mr5"></i>产品基本信息</h3>
                </div>
                <div class="panel-body">
                    <table>
                        <tbody>
                            <tr cid="Account" attrtype="checkbox" ismust="0">
                                <td class="firstTd">
    								发布站点:
    							</td>
    							<td class="secondTd">
    							<?php if(!empty($linioUsersDropdownList)):?>
    							<?php foreach($linioUsersDropdownList as $key => $val):?>
									<label><input class="label-check" type="checkbox" value="<?php echo $key;?>" data-val="" data-name="<?php echo "shop_".$key;?>" data-site="<?php echo $linioSitesDropdownList[$key]?>"> <?php echo $val?></label>
							    <?php endforeach;?>
							    <?php endif;?>
								</td>
                            </tr>
							...
							<tr cid="Color" attrtype="input" ismust="0">
								<td class="firstTd vAlignTop">Main Color:</td>
								<td class="secondTd"><input type="text" class="form-control" value=""></td>
							</tr>
                        </tbody>
                    </table>
                </div>
		    ...
		    <!--共有信息end-->
		    <!--各站点属性-->
		    <div id="base-info" class="panel panel-default form-horizontal form-bordered min">
		        <div class="panel-heading">
                    <h3 class="panel-title"><i class="ico-file4 mr5"></i>产品属性<span class="glyphicon glyphicon-chevron-up"></span></h3>
                </div>
                <div id="diff-show" class="panel-body show">
                
                </div>
		    </div>
		    <!--各站点属性end-->
			<!--产品属性-->
			<div id="product-info" class="panel panel-default form-horizontal form-bordered min" style="display:none">
			</div>
			<!--产品属性end-->
			<!--变参信息-->
			<div id="variant-info" class="panel panel-default form-horizontal form-bordered min">
				<div class="panel-heading">
...
//                         						]
			...
			<div class="bbar" style="border-top:3px solid #ddd;text-align:center;padding-top:5px;z-index: 11;">
				<button type="button" class="btn btn-sm btn-primary save-size" onclick="linioListing.mutsave(2);">保存并发布</button>
				<button type="button" class="btn btn-sm btn-primary save-size" onclick="linioListing.mutsave(1);">保存</button>
...
<div data-name="linio_float">
    <div class="modal fade" id="categoryChoose" tabindex="-1" data-name="linio_float_class" data-shop="replace_shop" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false" >
        	...
        	<div class="modal-content bs-example bs-example-tabs">
        		...
        		<div class="modal-body tab-content" style="padding-left:20px;padding-right:20px;">
        			<div style="height:34px;">
        				<span class="categoryChooseCrumbs ChooseCrumbs">
        			...
        			<div class="categoryChooseOutDiv ChooseOutDiv">
            			<div class="categoryChooseMiddleDiv ChooseMiddleDiv">
            				<div class="pull-left categoryChooseInDiv ChooseInDiv" data-level="1"></div>
            				<div class="pull-left categoryChooseInDiv ChooseInDiv" data-level="2"></div>
            				<div class="pull-left categoryChooseInDiv ChooseInDiv" data-level="3"></div>
            				<div class="pull-left categoryChooseInDiv ChooseInDiv" data-level="4"></div>
            				<div class="pull-left categoryChooseInDiv ChooseInDiv" data-level="5"></div>
            				<div class="pull-left categoryChooseInDiv ChooseInDiv" data-level="6"></div>
            			</div>
        			</div>
        		</div>
        		<!--modalFoot-->
