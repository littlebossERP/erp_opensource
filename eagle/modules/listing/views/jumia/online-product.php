...
$this->title = TranslateHelper::t("Jumia在线商品列表");
?>
<style>
.table td{
...
?>
<div class="col2-layout jumia-listing jumia-listing-online-product">
        <div class="search">
        <form action="/listing/jumia/online-product" method="get" id="online_search" name="online_search">
            ...
            <input class="btn btn-default btn-sm" type="button" value="批量修改" onclick="jumiaListing.checkBox()">
            <input class="btn btn-default btn-sm" type="button" value="同步商品" data-toggle="modal" data-target="#Sync_product" onclick="jumiaListing.reset()">
            <input class="btn btn-default btn-sm" type="button" value="搜索更新商品" data-toggle="modal" data-target="#search_product">
            <input class="btn btn-default btn-sm" type="button" value="批量下架" onclick="jumiaListing.batchPutOff()">
...
//                  }
                 ...
                 ?>
                    <tr data-id="<?php echo $parent_product['id']?>" class="striped-row">
                        ...
                        <a title="下架" onclick="jumiaListing.parentProductPutOff(this)"><span class="iconfont icon-xiajia"></span></a>
                        </td>
                    </tr>
                    ...
                    <tr class="detail_product product_<?php echo $parent_product['id']?> variation_tr" data-productid="<?php echo $detail_product['id']?>" style="display: none" >
                        ...
                        <?php endif;?>
                        <td class="table-operate-style">
                        <a title="下架" onclick="jumiaListing.productPutOff(<?php echo $detail_product['id']?>)"><span class="iconfont icon-xiajia"></span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
                 <?php endforeach;?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <span style="padding-left:55px"><label for="edit_type">修改选项：</label><?=Html::dropDownList('edit_type',@$_REQUEST['edit_type'],$edit_type,['onchange'=>"jumiaListing.editTypeChange(this)",'class'=>'eagle-form-control','id'=>'edit_type','style'=>'width:260px;','prompt'=>'请选择修改项'])?></span>
        <br /><span style="padding-left:55px;"><label for="edit_method">修改方式：</label><select id="edit_method" name="edit_method" class="eagle-form-control" style="width:260px;" onchange="jumiaListing.methodChange(this)"><option value="">请选择修改方式：</option></select></span>
      ...
      <div class="modal-footer">
        <input id="batch_edit_comfirm" value="确认" type="button" class="btn btn-primary" onclick="jumiaListing.batchEditSubmit()">
...
<div class="modal fade" id="Sync_product" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <input id="Sync_product_comfirm" value="手工同步" type="button" class="btn btn-primary" onclick="jumiaListing.SyncSubmit()">
        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
      </div>
      </form>
    </div>
...
<!-- 搜索 -->
<div class="modal fade" id="search_product" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <span style="padding-left:55px"><label for="lazada_uid">选择店铺：</label><?=Html::dropDownList('lazada_uid',@$_REQUEST['lazada_uid'],$shop_name,['onchange'=>"",'class'=>'eagle-form-control','id'=>'lazada_uid','style'=>'width:260px;','prompt'=>'请选择店铺'])?></span>
        
        <br /><span style="padding-left:55px"><label for="search_content">搜索内容：</label><input type="text" class="eagle-form-control" id="search_content" name="search_content" value=""></span> 
        <br /><span class="success_message" style="padding-left:55px;"></span> 
      </div>
      <div class="modal-footer">
        <input id="Sync_product_comfirm" value="搜索更新" type="button" class="btn btn-primary" onclick="jumiaListing.serachSubmit()">
        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
      </div>
      </form>
    </div>
