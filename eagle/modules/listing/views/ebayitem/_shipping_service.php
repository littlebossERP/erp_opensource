...
<?php 
	if (isset($data['shippingdetails']['ShippingServiceOptions']['ShippingService'])){
		$_tmp = $data['shippingdetails']['ShippingServiceOptions'];
		$data['shippingdetails']['ShippingServiceOptions'] = [$_tmp];
	}
?>
