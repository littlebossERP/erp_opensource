...
<form action="<?=Url::to(['/listing/ebayitem/update2'])?>" method="post">
...
<div class="panel panel-default">
  <div class="panel-body">
	...
	<hr/>
	<div class="row">
	  <div class="col-lg-2"><p class="text-right">买家要求<input class="part" type="checkbox" ></p></div>
	  <div class="col-lg-10">
	  <?=Html::checkBoxList('setitemvalues', '', array('buyerrequirementdetails'=>'买家要求'));?>
	  </div>
	</div>
	<hr/>
	<div class="row">
	...
	<div class="row">
	  ...
	  <div class="col-lg-10">
	  <input  type="submit" class="iv-btn btn-search" value=" 下 一 步  ">
	  <input  type="button" class="iv-btn btn-search" value=" 取 消  " onclick='window.close();'>
	  </div>
	</div>
  </div>
</div>
