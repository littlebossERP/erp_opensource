...
?>
<?php for($i=0;$i<5;$i++):?>
<div class="whole-onebox inshipping" id="inshippingservice_<?php echo $i?>" <?php if (!isset($data['shippingdetails']['InternationalShippingServiceOption'][$i]['ShippingService'])||(isset($data['shippingdetails']['InternationalShippingServiceOption'][$i]['ShippingService'])&&strlen($data['shippingdetails']['InternationalShippingServiceOption'][$i]['ShippingService'])==0)){echo 'style="display:none"';}?>>
...
<th>运输方式</th>
	...
	<?php echo Html::dropDownList('shippingdetails[InternationalShippingServiceOption]['.$i.'][ShippingService]',
			isset($data['shippingdetails']['InternationalShippingServiceOption'][$i]['ShippingService'])?$data['shippingdetails']['InternationalShippingServiceOption'][$i]['ShippingService']:'',$inshippingservice,['class'=>'iv-input fixed-boxsize'])?>
	</td>
</tr>
<tr>
<th>主运费</th>
