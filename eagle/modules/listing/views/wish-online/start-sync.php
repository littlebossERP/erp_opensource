...
<form class="form-horizontal" style="width:550px;height:230px;">
        ...
        <div class="col-xs-4 col-sm-4 col-lg-4" style="text-align:left;">
            <select class="p0 form-control" id="wish_modal_site_id" style="margin-top:0;">
                ...
                <?php foreach($wish_account as $id => $account):?>
                    <option value="<?=$account['site_id']?>" data-type="site_id" <?php if(count($wish_account) == 1): ?> selected="selected" <?php endif;?>><?=$account['store_name']?></option>
                <?php endforeach;?>
            </select>
        </div>
    ...
    <div class="form-group" style="text-align:center;margin-top:70px;">
        <a class="iv-btn btn-important sync-start" style="display:none;">开始</a>
