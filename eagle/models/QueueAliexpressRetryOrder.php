...
/**
 * This is the model class for table "queue_aliexpress_retry_order".
 *
 * @property string $id
 ...
 */
class QueueAliexpressRetryOrder extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'queue_aliexpress_retry_order';
    }
    /**
