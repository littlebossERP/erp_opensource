...
/**
 * This is the model class for table "saas_bonanza_user".
 *
 ...
 * @property integer $is_auto_accept
 */
class SaasBonanzaUser extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['is_active', 'uid', 'is_auto_accept'], 'integer'],
