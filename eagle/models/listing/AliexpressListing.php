...
class AliexpressListing extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['imageurls'], 'string'],
            [['ws_offline_date', 'gmt_modified', 'gmt_create', 'sku_stock', 'created', 'updated', 'product_status', 'edit_status'], 'integer'],
            [['product_min_price', 'product_max_price'], 'number'],
            [[ 'freight_template_id', 'owner_member_seq', 'selleruserid'], 'string', 'max' => 20],
