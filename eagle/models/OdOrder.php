...
class OdOrder extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['order_status', 'order_manual_id', 'pay_status', 'shipping_status', 'is_manual_order', 'saas_platform_user_id', 'order_source_srn', 'customer_id', 'order_source_create_time', 'default_warehouse_id', 'paid_time', 'delivery_time', 'create_time', 'update_time', 'carrier_type', 'is_feedback','printtime'], 'integer'],
