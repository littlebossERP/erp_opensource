...
function call_api( $get_params = array()  ,$return_type='json' ){
	...
	$url = 'http://localhost/Lazada_Proxy_Server/ApiEntry.php';
	...
	return $rtn;
	    ...
	    // all, live, inactive, deleted, image-missing, pending, rejected, sold-out
		$apiReqParams = array('filterStatus'=>Array('all', 'live', 'inactive', 'deleted', 'image-missing', 'pending', 'rejected', 'sold-out'));
