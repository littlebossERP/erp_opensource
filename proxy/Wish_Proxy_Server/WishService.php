...
//Amazon European proxy server machine
	...
	public static $wish_url_mapping = [
		'product'=>'https://merchant.wish.com/api/v1/product/multi-get',
		'variant'=>'https://merchant.wish.com/api/v1/variant/multi-get',
		'fulfillOne'=>'https://merchant.wish.com/api/v1/order/fulfill-one',
		'modifyTracking'=>'https://merchant.wish.com/api/v1/order/modify-tracking',
		'GetChangedOrder'=>'https://merchant.wish.com/api/v1/order/multi-get',
		'GetUnfulfillOrder'=>'https://merchant.wish.com/api/v1/order/get-fulfill',
		'getAwaitingTickets'=>'https://merchant.wish.com/api/v1/ticket/get-action-required',
		'replyTickets'=>'https://merchant.wish.com/api/v1/ticket/reply',
		'closeTicket'=>'https://merchant.wish.com/api/v1/ticket/close',
	];
