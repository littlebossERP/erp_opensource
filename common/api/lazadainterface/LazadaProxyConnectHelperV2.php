 ...
 * +---------------------------------------------------------------------------------------------
 **/
class LazadaProxyConnectHelperV2
{
...
// 			$TIME_OUT=60;//连接和网络读写超时时间，单位s
            ...
            $handle = curl_init($url);
//            CommonHelper::log("post data is:".json_encode($get_params));
//            CommonHelper::log("url is:".$url);
