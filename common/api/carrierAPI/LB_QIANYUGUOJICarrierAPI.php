...
class LB_QIANYUGUOJICarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "114.215.142.78:8082";
    static public $url2 = "114.215.142.78";
    ...
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_QIANYUGUOJICarrierAPI');
