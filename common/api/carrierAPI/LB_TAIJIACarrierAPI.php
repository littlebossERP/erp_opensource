...
class LB_TAIJIACarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "http://k5.takesend.com";
    ...
    {
        $base_config_obj = new YiYuTongBaseConfig($data, self::$url1,'LB_TAIJIACarrierAPI');
