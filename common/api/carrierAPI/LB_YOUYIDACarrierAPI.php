...
class LB_YOUYIDACarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "120.25.94.57:8082"; //提交订单地址
    static public $url2 = "120.25.94.57";   //打印地址
    ...
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_YOUYIDACarrierAPI');
    ...
    */
    ...
    public static function getCarrierLabelTypeStr($data){
    	//注意：一键标签的format_id可能没有，一键标签时请将print_type作为format_id保存入标签
    	$base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2);
