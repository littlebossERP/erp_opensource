...
class LB_ZXCarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "112.74.51.132:8082";
    static public $url2 = "112.74.51.132:8089";
    ...
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_ZXCarrierAPI');
