...
class LB_CHENGYOUSUDICarrierAPI extends BaseCarrierAPI
{
	static public $url1 = "120.77.201.224:8082"; //提交订单地址
	static public $url2 = "120.77.201.224:80";   //打印地址
	// 	.112.12.86:8089
	/**
	 +----------------------------------------------------------
	 * 申请订单号
	...
	{
		$base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_CHENGYOUSUDICarrierAPI');
