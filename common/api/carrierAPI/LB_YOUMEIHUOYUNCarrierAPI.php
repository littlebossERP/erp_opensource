...
class LB_YOUMEIHUOYUNCarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "112.74.135.134:8082";
    static public $url2 = "112.74.135.134";
    ...
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_YOUMEIHUOYUNCarrierAPI');
