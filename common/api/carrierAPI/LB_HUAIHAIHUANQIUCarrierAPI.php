...
class LB_HUAIHAIHUANQIUCarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "120.24.91.168:8082"; //提交订单地址  www.sz56t.com:8082
    static public $url2 = "120.24.91.168";   //打印地址   www.sz56t.com:8089
     ...
     * 申请订单号
     +----------------------------------------------------------
     * log			name		date				note
     * @author		lgw 		2016/07/26			初始化
     +----------------------------------------------------------
     **/
    public function getOrderNO($data)
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_HUAIHAIHUANQIUCarrierAPI');
