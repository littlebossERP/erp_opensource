...
class LB_YIDECarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "www.666post.com:8082"; //提交订单地址
    static public $url2 = "www.666post.com";   //打印地址
    ...
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_YIDECarrierAPI');
