...
class LB_HUIXIAOCarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "121.42.46.211:8082";
    static public $url2 = "121.42.46.211";
     ...
     * 申请订单号
     +----------------------------------------------------------
     * log			name		date				note
     * @author		lgw 		2016/07/13			初始化
     +----------------------------------------------------------
     **/
    public function getOrderNO($data)
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_HUIXIAOCarrierAPI');
