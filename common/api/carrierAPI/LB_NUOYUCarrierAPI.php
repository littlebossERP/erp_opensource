...
class LB_NUOYUCarrierAPI extends BaseCarrierAPI
{
	static public $url1 = "139.196.52.39:8082"; //提交订单地址
	static public $url2 = "139.196.52.39";   //打印地址
	...
	{
		$base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_NUOYUCarrierAPI');
