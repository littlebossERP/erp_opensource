...
class LB_CHAOGUANGSUCarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "www.sz56t.com:8082"; //提交订单地址
    static public $url2 = "www.sz56t.com:8089";   //打印地址
     ...
     * 申请订单号
     +----------------------------------------------------------
     * log			name		date				note
     * @author		lgw 		2017/03/30			初始化
     +----------------------------------------------------------
     **/
    public function getOrderNO($data)
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_CHAOGUANGSUCarrierAPI');
    ...
    {
    	$base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_JINYIJIECarrierAPI');
