...
class LB_HANGZHOUCHENGYOUCarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "120.77.201.224:8082";
    static public $url2 = "120.77.201.224:80";
     ...
     * 申请订单号
     +----------------------------------------------------------
     * log			name		date				note
     * @author		dwg 		2017/01/31			初始化
     +----------------------------------------------------------
     **/
    public function getOrderNO($data)
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_HANGZHOUCHENGYOUCarrierAPI');
