...
class LB_LINGDONGGUOJICarrierAPI extends BaseCarrierAPI
{
	static public $url1 = "118.89.152.79:8082"; //提交订单地址
	static public $url2 = "118.89.152.79:8089";   //打印地址
	/**
	 +----------------------------------------------------------
	 * 申请订单号
	 +----------------------------------------------------------
	...
	{
		$base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_LINGDONGGUOJICarrierAPI');
