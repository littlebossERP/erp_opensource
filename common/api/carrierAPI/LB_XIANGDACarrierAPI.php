...
class LB_XIANGDACarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "139.196.43.207:8082";
    static public $url2 = "139.196.43.207";
    ...
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_XIANGDACarrierAPI');
