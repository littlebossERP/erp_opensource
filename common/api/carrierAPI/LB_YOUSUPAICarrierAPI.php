...
class LB_YOUSUPAICarrierAPI extends BaseCarrierAPI
{
	static public $url1 = "119.23.21.120:8082"; //提交订单地址
	static public $url2 = "119.23.21.120:80";   //打印地址
	/**
	 +----------------------------------------------------------
	 * 申请订单号
	 +----------------------------------------------------------
	...
	{
		$base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_YOUSUPAICarrierAPI');
