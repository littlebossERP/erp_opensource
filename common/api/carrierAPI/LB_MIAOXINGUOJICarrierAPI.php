...
class LB_MIAOXINGUOJICarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "211.159.182.134:8082";
    static public $url2 = "211.159.182.134";
     ...
     * 申请订单号
     +----------------------------------------------------------
     * log			name		date				note
     * @author		lrq 		2016/07/21			初始化
     +----------------------------------------------------------
     **/
    public function getOrderNO($data)
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_MIAOXINGUOJICarrierAPI');
