...
class LB_BAIYUNGUOJICarrierAPI extends BaseCarrierAPI
{
	static public $url1 = "http://by.kingtrans.cn";
	...
	{
		$base_config_obj = new YiYuTongBaseConfig($data, self::$url1,'LB_BAIYUNGUOJICarrierAPI');
