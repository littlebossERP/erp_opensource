...
class LB_JIEYOUCarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "www.post56.cn:8082";
    static public $url2 = "www.post56.cn";
     ...
     * 申请订单号
     +----------------------------------------------------------
     * log			name		date				note
     * @author		lgw 		2016/11/30			初始化
     +----------------------------------------------------------
     **/
    public function getOrderNO($data)
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_JIEYOUCarrierAPI');
