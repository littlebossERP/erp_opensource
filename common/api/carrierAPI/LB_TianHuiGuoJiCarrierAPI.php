...
class LB_TianHuiGuoJiCarrierAPI extends BaseCarrierAPI
{
	static public $url1 = "120.24.169.145:8082"; //提交订单地址
	static public $url2 = "120.24.169.145:8089";   //打印地址
	// 	.112.12.86:8089
	/**
	 +----------------------------------------------------------
	 * 申请订单号
	...
	public function getOrderNO($data)
	{
		...
		$base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_TianHuiGuoJiCarrierAPI');
