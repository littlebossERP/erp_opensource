...
class LB_JIATENGCarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "114.215.115.218:8082";
    static public $url2 = "114.215.115.218:8080";
    ...
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_JIATENGCarrierAPI');
