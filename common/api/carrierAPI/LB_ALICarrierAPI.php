...
class LB_ALICarrierAPI extends BaseCarrierAPI
{
    static public $url1 = "120.24.176.176:8082"; //提交订单地址
    static public $url2 = "120.24.176.176";   //打印地址
    ...
    {
        $base_config_obj = new HuaLeiBaseConfig($data, self::$url1, self::$url2, 'LB_ALICarrierAPI');
