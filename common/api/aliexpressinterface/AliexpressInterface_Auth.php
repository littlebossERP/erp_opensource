...
class AliexpressInterface_Auth extends AliexpressInterface_Base{
	...
	private $_allow_ip= ["114.215.168.228","115.29.177.130","121.43.60.62","121.40.97.98","121.40.32.90","116.62.93.215","10.27.89.76","10.161.190.136"];
    /**
     * 第一步请求 授权
     * million 2014/07/16
     */         
    function startAuthUrl($state='state',$redirect_uri=''){
    	...
    	$url='http://'.$this->host.$param1.$param_str.'&_aop_signature='.$this->signature('',$param);
    	return $url;
    }
    #####################################################################################    
    /**
    ...
    function getToken($code='',$redirect_uri=''){
    	...
    	g) 调用getToken接口不需要签名
    	 */
    	$param1='http/1/system.oauth2/getToken/'.$this->AppKey;
