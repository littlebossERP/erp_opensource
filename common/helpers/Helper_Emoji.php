...
class Helper_Emoji
{
	...
	static public $emoji_maps = array(
		'names' => array(
	...
	static function emoji_docomo_to_unified(	$text){ return self::emoji_convert($text, 'docomo_to_unified'); }
	static function emoji_kddi_to_unified(		$text){ return self::emoji_convert($text, 'kddi_to_unified'); }
	static function emoji_softbank_to_unified(	$text){ return self::emoji_convert($text, 'softbank_to_unified'); }
	static function emoji_google_to_unified(	$text){ return self::emoji_convert($text, 'google_to_unified'); }
	...
	static function emoji_unified_to_docomo(	$text){ return self::emoji_convert($text, 'unified_to_docomo'); }
	static function emoji_unified_to_kddi(		$text){ return self::emoji_convert($text, 'unified_to_kddi'); }
	static function emoji_unified_to_softbank(	$text){ return self::emoji_convert($text, 'unified_to_softbank'); }
	static function emoji_unified_to_google(	$text){ return self::emoji_convert($text, 'unified_to_google'); }
	static function emoji_unified_to_html(		$text){ return self::emoji_convert($text, 'unified_to_html'); }

	static function emoji_html_to_unified(		$text){
		self::$emoji_maps['html_to_unified'] = array_flip(self::$emoji_maps['unified_to_html']); 
		return self::emoji_convert($text, 'html_to_unified'); 
	}



	static function emoji_convert($text, $map){
		return str_replace(array_keys(self::$emoji_maps[$map]), self::$emoji_maps[$map], $text);
	}

	static function emoji_get_name($unified_cp){

		return self::$emoji_maps['names'][$unified_cp] ? self::$emoji_maps['names'][$unified_cp] : '?';
	}

	static function utf8_bytes($cp){
